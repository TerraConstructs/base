// https://github.com/aws/aws-cdk/blob/v2.186.0/packages/aws-cdk-lib/core/test/fs/fs-copy.test.ts
...
describe("fs copy", () => {
  ...
  test("Always: follow all symlinks", () => {
    ...
    FileSystem.copyDirectory(
      path.join(__dirname, "fixtures", "symlinks"),
      outdir,
      {
