// https://github.com/aws/aws-cdk/blob/v2.186.0/packages/aws-cdk-lib/aws-dynamodb/test/capacity.test.ts

import { Capacity, CapacityMode } from "../../../src/aws/storage/capacity";
...
describe("autoscaled capacity", () => {
  ...
  test("can render capacity with non-default target utilization", () => {
    // GIVEN
    const capacity = Capacity.autoscaled({
      maxCapacity: 10,
