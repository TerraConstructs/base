// upstream @aws-cdk/aws-redshift-alpha has no dedicated `test/endpoint.test.ts` (Endpoint is only
// exercised indirectly via cluster.test.ts). This file mirrors the sibling
// `../neptune/endpoint.test.ts` port (itself from
// https://github.com/aws/aws-cdk/blob/v2.263.0/packages/@aws-cdk/aws-neptune-alpha/test/endpoint.test.ts),
// since `redshift.Endpoint` is structurally identical to `neptune.Endpoint` (hostname/port/socketAddress).

import { Token } from "cdktn";
import { Endpoint } from "../../../../src/aws/storage/redshift";
