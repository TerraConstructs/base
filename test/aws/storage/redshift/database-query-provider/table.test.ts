// https://github.com/aws/aws-cdk/blob/v2.263.0/packages/@aws-cdk/aws-redshift-alpha/test/database-query-provider/table.test.ts
//
...
test.skip("scope-reduction: test/database-query-provider/table.test.ts ported commented-out, see TODO above", () => {});

// -- BEGIN fully commented-out upstream port of test/database-query-provider/table.test.ts --
//
//
...
// });
//
// -- END fully commented-out upstream port of test/database-query-provider/table.test.ts --
