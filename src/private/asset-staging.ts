// https://github.com/aws/aws-cdk/blob/v2.186.0/packages/aws-cdk-lib/core/lib/private/asset-staging.ts
...
// Bundling directory constants (not exported by cdktn's AssetStaging)
...
export class AssetBundlingBindMount extends AssetBundlingBase {
  ...
  public run() {
    this.options.image.run({
      ...
      workingDirectory: this.options.workingDirectory ?? BUNDLING_INPUT_DIR,
