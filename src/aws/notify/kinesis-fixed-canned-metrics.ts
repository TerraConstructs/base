// https://github.com/aws/aws-cdk/blob/v2.170.0/packages/aws-cdk-lib/aws-kinesis/lib/kinesis-fixed-canned-metrics.ts

// Canned metrics
// via          https://github.com/cdklabs/awscdk-service-spec/blob/main/sources/CloudWatchConsoleServiceDirectory/README.md
// generated by https://github.com/aws/aws-cdk/blob/v2.170.0/packages/aws-cdk-lib/scripts/gen.ts
...
export class KinesisMetrics {
  ...
  public static getRecordsIteratorAgeMillisecondsMaximum(dimensions: {
    StreamName: string;
  }) {
  ...
  public static putRecordsTotalRecordsAverage(dimensions: {
    StreamName: string;
  }) {
    return {
      namespace: "AWS/Kinesis",
  ...
  public static putRecordsSuccessfulRecordsAverage(dimensions: {
    StreamName: string;
  }) {
    return {
      namespace: "AWS/Kinesis",
  ...
  public static putRecordsFailedRecordsAverage(dimensions: {
    StreamName: string;
  }) {
    return {
      namespace: "AWS/Kinesis",
  ...
  public static putRecordsThrottledRecordsAverage(dimensions: {
    StreamName: string;
  }) {
    return {
      namespace: "AWS/Kinesis",
  ...
  public static readProvisionedThroughputExceededAverage(dimensions: {
    StreamName: string;
  }) {
    return {
  ...
  public static writeProvisionedThroughputExceededAverage(dimensions: {
    StreamName: string;
  }) {
    return {
