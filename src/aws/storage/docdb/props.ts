// https://github.com/aws/aws-cdk/blob/v2.263.0/packages/aws-cdk-lib/aws-docdb/lib/props.ts

import { Duration } from "../../../duration";
import type * as encryption from "../../encryption";

// TERRACONSTRUCTS DEVIATION: upstream types `Login.password` as `core.SecretValue` (a
// CloudFormation dynamic-reference wrapper), which is not ported in this repo (see the identical
// deviation on `../rds/props.ts`'s `Credentials.password`). It is a plain `string` instead (which
// may itself be an unresolved Token).
...
export interface Login {
   ...
   *
   * TERRACONSTRUCTS DEVIATION: `string` instead of upstream's `core.SecretValue` — see the file
   * header note above.
   *
