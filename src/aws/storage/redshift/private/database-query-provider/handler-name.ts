// https://github.com/aws/aws-cdk/blob/v2.263.0/packages/@aws-cdk/aws-redshift-alpha/lib/private/database-query-provider/handler-name.ts
//
...
//
// -- BEGIN fully commented-out upstream port of lib/private/database-query-provider/handler-name.ts --
//
...
// }
//
// -- END fully commented-out upstream port of lib/private/database-query-provider/handler-name.ts --
