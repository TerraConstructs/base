// https://github.com/aws/aws-cdk/blob/v2.263.0/packages/@aws-cdk/aws-redshift-alpha/lib/table.ts
//
...
//
// -- BEGIN fully commented-out upstream port of lib/table.ts --
//
//
...
// }
//
// -- END fully commented-out upstream port of lib/table.ts --
