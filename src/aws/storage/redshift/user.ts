// https://github.com/aws/aws-cdk/blob/v2.263.0/packages/@aws-cdk/aws-redshift-alpha/lib/user.ts
//
...
//
// -- BEGIN fully commented-out upstream port of lib/user.ts --
//
...
// }
//
// -- END fully commented-out upstream port of lib/user.ts --
