// https://github.com/aws/aws-cdk/blob/v2.263.0/packages/@aws-cdk/aws-s3tables-alpha/lib/permissions.ts
//
...
export const TABLE_BUCKET_READ_WRITE_ACCESS = [
  ...new Set([...TABLE_BUCKET_READ_ACCESS, ...TABLE_BUCKET_WRITE_ACCESS]),
];

// Table
// Read privileges
export const TABLE_READ_ACCESS = ["s3tables:Get*"];
// Write privileges
...
export const TABLE_READ_WRITE_ACCESS = [
  ...new Set([...TABLE_READ_ACCESS, ...TABLE_WRITE_ACCESS]),
];
...
export const KEY_READ_WRITE_ACCESS = [
  ...new Set([...KEY_READ_ACCESS, ...KEY_WRITE_ACCESS]),
];
