// https://github.com/aws/aws-cdk/blob/v2.263.0/packages/@aws-cdk/aws-neptune-alpha/lib/endpoint.ts
 ...
 * and `../docdb/endpoint.ts`) -- `socketAddress` below is a plain (unmemoized) getter instead.
 */
