// https://github.com/aws/aws-cdk/blob/v2.263.0/packages/aws-cdk-lib/aws-rds/lib/cluster-engine.ts
...
export interface ClusterEngineBindOptions {
   ...
   * @default - none
   *
   * TERRACONSTRUCTS DEVIATION: upstream types this `iam.IRoleRef`, a CloudFormation cross-stack
   * "Reference" marker interface generated from the CFN resource spec. TerraConstructs has no
   * equivalent generated-reference layer (see the identical note on `IParameterGroup` in
   * `./parameter-group.ts`), so the base `iam.IRole` is used here instead —
   * https://github.com/aws/aws-cdk/blob/v2.263.0/packages/aws-cdk-lib/aws-rds/lib/cluster-engine.ts#L17-L21
   */
   ...
   *  @default - none
   *
   * TERRACONSTRUCTS DEVIATION: see `s3ImportRole` note above; `iam.IRoleRef` substituted with `iam.IRole` —
   * https://github.com/aws/aws-cdk/blob/v2.263.0/packages/aws-cdk-lib/aws-rds/lib/cluster-engine.ts#L23-L28
   */
...
interface ClusterEngineBaseProps {
  ...
  // TERRACONSTRUCTS DEVIATION: upstream takes the resolved `secretsmanager.SecretRotationApplication`
  // value directly here. This repo takes a thunk instead, so that reading
  // `secretsmanager.SecretRotationApplication.*` (from `../../encryption`) is deferred from
  // "when this engine is constructed" to "when `singleUserRotationApplication`/
  // `multiUserRotationApplication` is first accessed" -- see the matching deviation note on
  // `ClusterEngineBase` below for why that indirection is needed.
  readonly singleUserRotationApplication: () => secretsmanager.SecretRotationApplication;
  readonly multiUserRotationApplication: () => secretsmanager.SecretRotationApplication;
...
abstract class ClusterEngineBase implements IClusterEngine {
  ...
  // TERRACONSTRUCTS DEVIATION: `../../encryption` (which defines `SecretRotationApplication`)
  // transitively imports back into this `../../storage/rds` barrel (secret rotation constructs
  // need VPC/security-group types; Lambda `Code` assets need S3/ECR types), a real module import
  // cycle. Reading `secretsmanager.SecretRotationApplication.*` while that cycle is still
  // resolving throws "Cannot read properties of undefined". Rather than eagerly resolving the
  // rotation application in the constructor, it's stored as a thunk and resolved (and memoized)
  // lazily on first access via the getters below, by which point the whole module graph has
  // finished loading. This keeps `singleUserRotationApplication`/`multiUserRotationApplication`
  // as ordinary read-only properties on `IClusterEngine` -- callers can't tell the difference --
  // and, crucially, lets `DatabaseClusterEngine`'s unversioned convenience engines (e.g. `AURORA`)
  // go back to being plain, eagerly-evaluated readonly static fields like upstream,
  // since constructing an `XClusterEngine()` no longer touches `../../encryption` at all.
  private readonly _singleUserRotationApplication: () => secretsmanager.SecretRotationApplication;
  private readonly _multiUserRotationApplication: () => secretsmanager.SecretRotationApplication;
  private __singleUserRotationApplication?: secretsmanager.SecretRotationApplication;
  private __multiUserRotationApplication?: secretsmanager.SecretRotationApplication;

  constructor(props: ClusterEngineBaseProps) {
    this.engineType = props.engineType;
    this.features = props.features;
    this._singleUserRotationApplication = props.singleUserRotationApplication;
    this._multiUserRotationApplication = props.multiUserRotationApplication;
  ...
  public get singleUserRotationApplication(): secretsmanager.SecretRotationApplication {
    return (this.__singleUserRotationApplication ??=
      this._singleUserRotationApplication());
  }

  public get multiUserRotationApplication(): secretsmanager.SecretRotationApplication {
    return (this.__multiUserRotationApplication ??=
      this._multiUserRotationApplication());
  }
  ...
  public bindToCluster(
    ...
    const parameterGroup =
      options.parameterGroup ?? this.defaultParameterGroup(scope);
    return {
      parameterGroup,
   ...
   */
  protected abstract defaultParameterGroup(
    scope: Construct,
  ): IParameterGroup | undefined;
}
...
abstract class MySqlClusterEngineBase extends ClusterEngineBase {
   ...
   */
  public readonly supportedLogTypes: string[] = [
    "error",
    "general",
    "slowquery",
    "audit",
...
export class AuroraEngineVersion {
  /** Version "5.6.10a". */
  public static readonly VER_10A = AuroraEngineVersion.builtIn_5_6(
    "10a",
    false,
  );
  ...
  public static readonly VER_1_22_1_3 =
    AuroraEngineVersion.builtIn_5_6("1.22.1.3");
...
class AuroraClusterEngine extends MySqlClusterEngineBase {
  ...
  protected defaultParameterGroup(
    _scope: Construct,
  ): IParameterGroup | undefined {
...
export class AuroraMysqlEngineVersion {
   ...
   */
  public static readonly VER_5_7_12 = AuroraMysqlEngineVersion.builtIn_5_7(
    "12",
    false,
  );
  /**
   ...
   */
  public static readonly VER_2_11_0 =
    AuroraMysqlEngineVersion.builtIn_5_7("2.11.0");
  ...
  public static readonly VER_2_11_2 =
    AuroraMysqlEngineVersion.builtIn_5_7("2.11.2");
  /** Version "5.7.mysql_aurora.2.11.3". */
  public static readonly VER_2_11_3 =
    AuroraMysqlEngineVersion.builtIn_5_7("2.11.3");
  /** Version "5.7.mysql_aurora.2.11.4". */
  public static readonly VER_2_11_4 =
    AuroraMysqlEngineVersion.builtIn_5_7("2.11.4");
  /** Version "5.7.mysql_aurora.2.11.5". */
  public static readonly VER_2_11_5 =
    AuroraMysqlEngineVersion.builtIn_5_7("2.11.5");
  /** Version "5.7.mysql_aurora.2.11.6". */
  public static readonly VER_2_11_6 =
    AuroraMysqlEngineVersion.builtIn_5_7("2.11.6");
  /** Version "5.7.mysql_aurora.2.12.0". */
  public static readonly VER_2_12_0 =
    AuroraMysqlEngineVersion.builtIn_5_7("2.12.0");
  /** Version "5.7.mysql_aurora.2.12.1". */
  public static readonly VER_2_12_1 =
    AuroraMysqlEngineVersion.builtIn_5_7("2.12.1");
  /** Version "5.7.mysql_aurora.2.12.2". */
  public static readonly VER_2_12_2 =
    AuroraMysqlEngineVersion.builtIn_5_7("2.12.2");
  /** Version "5.7.mysql_aurora.2.12.3". */
  public static readonly VER_2_12_3 =
    AuroraMysqlEngineVersion.builtIn_5_7("2.12.3");
  /** Version "5.7.mysql_aurora.2.12.4". */
  public static readonly VER_2_12_4 =
    AuroraMysqlEngineVersion.builtIn_5_7("2.12.4");
  /** Version "5.7.mysql_aurora.2.12.5". */
  public static readonly VER_2_12_5 =
    AuroraMysqlEngineVersion.builtIn_5_7("2.12.5");
  /** Version "5.7.mysql_aurora.2.12.6". */
  public static readonly VER_2_12_6 =
    AuroraMysqlEngineVersion.builtIn_5_7("2.12.6");
  /**
   * Version "8.0.mysql_aurora.3.01.0"
   * @deprecated Aurora MySQL 8.0.mysql_aurora.3.01.0 is no longer supported by Amazon RDS.
   */
  public static readonly VER_3_01_0 =
    AuroraMysqlEngineVersion.builtIn_8_0("3.01.0");
  /**
   * Version "8.0.mysql_aurora.3.01.1"
   * @deprecated Aurora MySQL 8.0.mysql_aurora.3.01.1 is no longer supported by Amazon RDS.
   */
  public static readonly VER_3_01_1 =
    AuroraMysqlEngineVersion.builtIn_8_0("3.01.1");
  /**
   * Version "8.0.mysql_aurora.3.02.0"
   * @deprecated Aurora MySQL 8.0.mysql_aurora.3.02.0 is no longer supported by Amazon RDS.
   */
  public static readonly VER_3_02_0 =
    AuroraMysqlEngineVersion.builtIn_8_0("3.02.0");
  /**
   * Version "8.0.mysql_aurora.3.02.1"
   * @deprecated Aurora MySQL 8.0.mysql_aurora.3.02.1 is no longer supported by Amazon RDS.
   */
  public static readonly VER_3_02_1 =
    AuroraMysqlEngineVersion.builtIn_8_0("3.02.1");
  /**
   * Version "8.0.mysql_aurora.3.02.2"
   * @deprecated Aurora MySQL 8.0.mysql_aurora.3.02.2 is no longer supported by Amazon RDS.
   */
  public static readonly VER_3_02_2 =
    AuroraMysqlEngineVersion.builtIn_8_0("3.02.2");
  /**
   * Version "8.0.mysql_aurora.3.02.3"
   * @deprecated Aurora MySQL 8.0.mysql_aurora.3.02.3 is no longer supported by Amazon RDS.
   */
  public static readonly VER_3_02_3 =
    AuroraMysqlEngineVersion.builtIn_8_0("3.02.3");
  /**
   * Version "8.0.mysql_aurora.3.03.0"
   * @deprecated Aurora MySQL 8.0.mysql_aurora.3.03.0 is no longer supported by Amazon RDS.
   */
  public static readonly VER_3_03_0 =
    AuroraMysqlEngineVersion.builtIn_8_0("3.03.0");
  /**
   * Version "8.0.mysql_aurora.3.03.1"
   * @deprecated Aurora MySQL 8.0.mysql_aurora.3.03.1 is no longer supported by Amazon RDS.
   */
  public static readonly VER_3_03_1 =
   ...
   */
  public static readonly VER_3_03_2 =
    AuroraMysqlEngineVersion.builtIn_8_0("3.03.2");
  /**
   * Version "8.0.mysql_aurora.3.03.3"
   * @deprecated Aurora MySQL 8.0.mysql_aurora.3.03.3 is no longer supported by Amazon RDS.
   */
  public static readonly VER_3_03_3 =
    AuroraMysqlEngineVersion.builtIn_8_0("3.03.3");
  /** Version "8.0.mysql_aurora.3.04.0". */
  public static readonly VER_3_04_0 =
    AuroraMysqlEngineVersion.builtIn_8_0("3.04.0");
  /** Version "8.0.mysql_aurora.3.04.1". */
  public static readonly VER_3_04_1 =
    AuroraMysqlEngineVersion.builtIn_8_0("3.04.1");
  /** Version "8.0.mysql_aurora.3.04.2". */
  public static readonly VER_3_04_2 =
    AuroraMysqlEngineVersion.builtIn_8_0("3.04.2");
  /** Version "8.0.mysql_aurora.3.04.3". */
  public static readonly VER_3_04_3 =
    AuroraMysqlEngineVersion.builtIn_8_0("3.04.3");
  /** Version "8.0.mysql_aurora.3.04.4". */
  public static readonly VER_3_04_4 =
    AuroraMysqlEngineVersion.builtIn_8_0("3.04.4");
  /** Version "8.0.mysql_aurora.3.04.6". */
  public static readonly VER_3_04_6 =
    AuroraMysqlEngineVersion.builtIn_8_0("3.04.6");
  /**
   * Version "8.0.mysql_aurora.3.05.0"
   * @deprecated Aurora MySQL 8.0.mysql_aurora.3.05.0 is no longer supported by Amazon RDS.
   */
  public static readonly VER_3_05_0 =
    AuroraMysqlEngineVersion.builtIn_8_0("3.05.0");
  /**
   * Version "8.0.mysql_aurora.3.05.1"
   * @deprecated Aurora MySQL 8.0.mysql_aurora.3.05.1 is no longer supported by Amazon RDS.
   */
  public static readonly VER_3_05_1 =
    AuroraMysqlEngineVersion.builtIn_8_0("3.05.1");
  /**
   * Version "8.0.mysql_aurora.3.05.2"
   * @deprecated Aurora MySQL 8.0.mysql_aurora.3.05.2 is no longer supported by Amazon RDS.
   */
  public static readonly VER_3_05_2 =
    AuroraMysqlEngineVersion.builtIn_8_0("3.05.2");
  /**
   * Version "8.0.mysql_aurora.3.06.0"
   * @deprecated Aurora MySQL 8.0.mysql_aurora.3.06.0 is no longer supported by Amazon RDS.
   */
  public static readonly VER_3_06_0 =
    AuroraMysqlEngineVersion.builtIn_8_0("3.06.0");
  /**
   * Version "8.0.mysql_aurora.3.06.1"
   * @deprecated Aurora MySQL 8.0.mysql_aurora.3.06.1 is no longer supported by Amazon RDS.
   */
  public static readonly VER_3_06_1 =
    AuroraMysqlEngineVersion.builtIn_8_0("3.06.1");
  /**
   * Version "8.0.mysql_aurora.3.07.0"
   * @deprecated Aurora MySQL 8.0.mysql_aurora.3.07.0 is no longer supported by Amazon RDS.
   */
  public static readonly VER_3_07_0 =
    AuroraMysqlEngineVersion.builtIn_8_0("3.07.0");
  /**
   * Version "8.0.mysql_aurora.3.07.1"
   * @deprecated Aurora MySQL 8.0.mysql_aurora.3.07.1 is no longer supported by Amazon RDS.
   */
  public static readonly VER_3_07_1 =
    AuroraMysqlEngineVersion.builtIn_8_0("3.07.1");
  /** Version "8.0.mysql_aurora.3.08.0". */
  public static readonly VER_3_08_0 =
    AuroraMysqlEngineVersion.builtIn_8_0("3.08.0");
  /** Version "8.0.mysql_aurora.3.08.1". */
  public static readonly VER_3_08_1 =
    AuroraMysqlEngineVersion.builtIn_8_0("3.08.1");
  /** Version "8.0.mysql_aurora.3.08.2". */
  public static readonly VER_3_08_2 =
    AuroraMysqlEngineVersion.builtIn_8_0("3.08.2");
  /** Version "8.0.mysql_aurora.3.09.0". */
  public static readonly VER_3_09_0 =
    AuroraMysqlEngineVersion.builtIn_8_0("3.09.0");
  /** Version "8.0.mysql_aurora.3.10.0". */
  public static readonly VER_3_10_0 =
    AuroraMysqlEngineVersion.builtIn_8_0("3.10.0");
  /** Version "8.0.mysql_aurora.3.10.1". */
  public static readonly VER_3_10_1 =
    AuroraMysqlEngineVersion.builtIn_8_0("3.10.1");
  /** Version "8.0.mysql_aurora.3.10.2". */
  public static readonly VER_3_10_2 =
    AuroraMysqlEngineVersion.builtIn_8_0("3.10.2");
  /** Version "8.0.mysql_aurora.3.10.3". */
  public static readonly VER_3_10_3 =
    AuroraMysqlEngineVersion.builtIn_8_0("3.10.3");
  /** Version "8.0.mysql_aurora.3.10.4". */
  public static readonly VER_3_10_4 =
    AuroraMysqlEngineVersion.builtIn_8_0("3.10.4");
  /** Version "8.0.mysql_aurora.3.11.0". */
  public static readonly VER_3_11_0 =
    AuroraMysqlEngineVersion.builtIn_8_0("3.11.0");
  /** Version "8.0.mysql_aurora.3.11.1". */
  public static readonly VER_3_11_1 =
    AuroraMysqlEngineVersion.builtIn_8_0("3.11.1");
  /** Version "8.0.mysql_aurora.3.12.0". */
  public static readonly VER_3_12_0 =
    AuroraMysqlEngineVersion.builtIn_8_0("3.12.0");
  ...
  public static of(
    ...
    const serverlessV2AutoPauseSupported =
      auroraMysqlMajorVersion === "8.0"
    ...
    return new AuroraMysqlEngineVersion(
      ...
      {
        combineImportAndExportRoles: auroraMysqlMajorVersion
  ...
  private constructor(
    ...
    this._combineImportAndExportRoles =
      auroraMysqlEngineVersionOptions?.combineImportAndExportRoles;
    this._serverlessV2AutoPauseSupported =
      auroraMysqlEngineVersionOptions?.serverlessV2AutoPauseSupported;
  }
}
...
export class AuroraPostgresEngineVersion {
   ...
   */
  public static readonly VER_9_6_8 = AuroraPostgresEngineVersion.of(
    "9.6.8",
    "9.6",
  );
  /**
   ...
   */
  public static readonly VER_9_6_9 = AuroraPostgresEngineVersion.of(
    "9.6.9",
    "9.6",
  );
  /**
   ...
   */
  public static readonly VER_9_6_11 = AuroraPostgresEngineVersion.of(
    "9.6.11",
    "9.6",
  );
  /**
   ...
   */
  public static readonly VER_9_6_12 = AuroraPostgresEngineVersion.of(
    "9.6.12",
    "9.6",
  );
  /**
   ...
   */
  public static readonly VER_9_6_16 = AuroraPostgresEngineVersion.of(
    "9.6.16",
    "9.6",
  );
  /**
   ...
   */
  public static readonly VER_9_6_17 = AuroraPostgresEngineVersion.of(
    "9.6.17",
    "9.6",
  );
  /**
   ...
   */
  public static readonly VER_9_6_18 = AuroraPostgresEngineVersion.of(
    "9.6.18",
    "9.6",
  );
  /**
   ...
   */
  public static readonly VER_9_6_19 = AuroraPostgresEngineVersion.of(
    "9.6.19",
    "9.6",
  );
  /**
   ...
   */
  public static readonly VER_9_6_22 = AuroraPostgresEngineVersion.of(
    "9.6.22",
    "9.6",
  );
  /**
   ...
   */
  public static readonly VER_10_4 = AuroraPostgresEngineVersion.of(
    "10.4",
    "10",
  );
  /**
   ...
   */
  public static readonly VER_10_5 = AuroraPostgresEngineVersion.of(
    "10.5",
    "10",
  );
  /**
   ...
   */
  public static readonly VER_10_6 = AuroraPostgresEngineVersion.of(
    "10.6",
    "10",
  );
  /**
   ...
   */
  public static readonly VER_10_7 = AuroraPostgresEngineVersion.of(
    "10.7",
    "10",
    { s3Import: true },
  );
   ...
   */
  public static readonly VER_10_11 = AuroraPostgresEngineVersion.of(
    "10.11",
    "10",
   ...
   */
  public static readonly VER_10_12 = AuroraPostgresEngineVersion.of(
    "10.12",
    "10",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_10_13 = AuroraPostgresEngineVersion.of(
    "10.13",
    "10",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_10_14 = AuroraPostgresEngineVersion.of(
    "10.14",
    "10",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_10_16 = AuroraPostgresEngineVersion.of(
    "10.16",
    "10",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_10_17 = AuroraPostgresEngineVersion.of(
    "10.17",
    "10",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_10_18 = AuroraPostgresEngineVersion.of(
    "10.18",
    "10",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_10_19 = AuroraPostgresEngineVersion.of(
    "10.19",
    "10",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_10_20 = AuroraPostgresEngineVersion.of(
    "10.20",
    "10",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_10_21 = AuroraPostgresEngineVersion.of(
    "10.21",
    "10",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_11_4 = AuroraPostgresEngineVersion.of(
    "11.4",
    "11",
    { s3Import: true },
  );
   ...
   */
  public static readonly VER_11_6 = AuroraPostgresEngineVersion.of(
    "11.6",
    "11",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_11_7 = AuroraPostgresEngineVersion.of(
    "11.7",
    "11",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_11_8 = AuroraPostgresEngineVersion.of(
    "11.8",
    "11",
    { s3Import: true, s3Export: true },
  );
  /** Version "11.9". */
  public static readonly VER_11_9 = AuroraPostgresEngineVersion.of(
    "11.9",
    "11",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_11_11 = AuroraPostgresEngineVersion.of(
    "11.11",
    "11",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_11_12 = AuroraPostgresEngineVersion.of(
    "11.12",
    "11",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_11_13 = AuroraPostgresEngineVersion.of(
    "11.13",
    "11",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_11_14 = AuroraPostgresEngineVersion.of(
    "11.14",
    "11",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_11_15 = AuroraPostgresEngineVersion.of(
    "11.15",
    "11",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_11_16 = AuroraPostgresEngineVersion.of(
    "11.16",
    "11",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_11_17 = AuroraPostgresEngineVersion.of(
    "11.17",
    "11",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_11_18 = AuroraPostgresEngineVersion.of(
    "11.18",
    "11",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_11_19 = AuroraPostgresEngineVersion.of(
    "11.19",
    "11",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_11_20 = AuroraPostgresEngineVersion.of(
    "11.20",
    "11",
    { s3Import: true, s3Export: true },
  );
  /** Version "11.21". */
  public static readonly VER_11_21 = AuroraPostgresEngineVersion.of(
    "11.21",
    "11",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_12_4 = AuroraPostgresEngineVersion.of(
    "12.4",
    "12",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_12_6 = AuroraPostgresEngineVersion.of(
    "12.6",
    "12",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_12_7 = AuroraPostgresEngineVersion.of(
    "12.7",
    "12",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_12_8 = AuroraPostgresEngineVersion.of(
    "12.8",
    "12",
    { s3Import: true, s3Export: true },
  );
  /** Version "12.9". */
  public static readonly VER_12_9 = AuroraPostgresEngineVersion.of(
    "12.9",
    "12",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_12_10 = AuroraPostgresEngineVersion.of(
    "12.10",
    "12",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_12_11 = AuroraPostgresEngineVersion.of(
    "12.11",
    "12",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_12_12 = AuroraPostgresEngineVersion.of(
    "12.12",
    "12",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_12_13 = AuroraPostgresEngineVersion.of(
    "12.13",
    "12",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_12_14 = AuroraPostgresEngineVersion.of(
    "12.14",
    "12",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_12_15 = AuroraPostgresEngineVersion.of(
    "12.15",
    "12",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_12_16 = AuroraPostgresEngineVersion.of(
    "12.16",
    "12",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_12_17 = AuroraPostgresEngineVersion.of(
    "12.17",
    "12",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_12_18 = AuroraPostgresEngineVersion.of(
    "12.18",
    "12",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_12_19 = AuroraPostgresEngineVersion.of(
    "12.19",
    "12",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_12_20 = AuroraPostgresEngineVersion.of(
    "12.20",
    "12",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_12_21 = AuroraPostgresEngineVersion.of(
    "12.21",
    "12",
    { s3Import: true, s3Export: true },
  );
  /** Version "12.22". */
  public static readonly VER_12_22 = AuroraPostgresEngineVersion.of(
    "12.22",
    "12",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_13_3 = AuroraPostgresEngineVersion.of(
    "13.3",
    "13",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_13_4 = AuroraPostgresEngineVersion.of(
    "13.4",
    "13",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_13_5 = AuroraPostgresEngineVersion.of(
    "13.5",
    "13",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_13_6 = AuroraPostgresEngineVersion.of(
    "13.6",
    "13",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_13_7 = AuroraPostgresEngineVersion.of(
    "13.7",
    "13",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_13_8 = AuroraPostgresEngineVersion.of(
    "13.8",
    "13",
    { s3Import: true, s3Export: true },
  );
  /** Version "13.9". */
  public static readonly VER_13_9 = AuroraPostgresEngineVersion.of(
    "13.9",
    "13",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_13_10 = AuroraPostgresEngineVersion.of(
    "13.10",
    "13",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_13_11 = AuroraPostgresEngineVersion.of(
    "13.11",
    "13",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_13_12 = AuroraPostgresEngineVersion.of(
    "13.12",
    "13",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_13_13 = AuroraPostgresEngineVersion.of(
    "13.13",
    "13",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_13_14 = AuroraPostgresEngineVersion.of(
    "13.14",
    "13",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_13_15 = AuroraPostgresEngineVersion.of(
    "13.15",
    "13",
    { s3Import: true, s3Export: true },
  );
  /** Version "13.16". */
  public static readonly VER_13_16 = AuroraPostgresEngineVersion.of(
    "13.16",
    "13",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_13_17 = AuroraPostgresEngineVersion.of(
    "13.17",
    "13",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_13_18 = AuroraPostgresEngineVersion.of(
    "13.18",
    "13",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_13_20 = AuroraPostgresEngineVersion.of(
    "13.20",
    "13",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_13_21 = AuroraPostgresEngineVersion.of(
    "13.21",
    "13",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_13_22 = AuroraPostgresEngineVersion.of(
    "13.22",
    "13",
    { s3Import: true, s3Export: true },
  );
  /** Version "13.23". */
  public static readonly VER_13_23 = AuroraPostgresEngineVersion.of(
    "13.23",
    "13",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_14_3 = AuroraPostgresEngineVersion.of(
    "14.3",
    "14",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_14_4 = AuroraPostgresEngineVersion.of(
    "14.4",
    "14",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_14_5 = AuroraPostgresEngineVersion.of(
    "14.5",
    "14",
    { s3Import: true, s3Export: true },
  );
  /** Version "14.6". */
  public static readonly VER_14_6 = AuroraPostgresEngineVersion.of(
    "14.6",
    "14",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_14_7 = AuroraPostgresEngineVersion.of(
    "14.7",
    "14",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_14_8 = AuroraPostgresEngineVersion.of(
    "14.8",
    "14",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_14_9 = AuroraPostgresEngineVersion.of(
    "14.9",
    "14",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_14_10 = AuroraPostgresEngineVersion.of(
    "14.10",
    "14",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_14_11 = AuroraPostgresEngineVersion.of(
    "14.11",
    "14",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_14_12 = AuroraPostgresEngineVersion.of(
    "14.12",
    "14",
    { s3Import: true, s3Export: true },
  );
  /** Version "14.13". */
  public static readonly VER_14_13 = AuroraPostgresEngineVersion.of(
    "14.13",
    "14",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_14_14 = AuroraPostgresEngineVersion.of(
    "14.14",
    "14",
    { s3Import: true, s3Export: true },
  );
  /** Version "14.15". */
  public static readonly VER_14_15 = AuroraPostgresEngineVersion.of(
    "14.15",
    "14",
    { s3Import: true, s3Export: true },
  );
  /** Version "14.17". */
  public static readonly VER_14_17 = AuroraPostgresEngineVersion.of(
    "14.17",
    "14",
    { s3Import: true, s3Export: true },
  );
  /** Version "14.18". */
  public static readonly VER_14_18 = AuroraPostgresEngineVersion.of(
    "14.18",
    "14",
    { s3Import: true, s3Export: true },
  );
  /** Version "14.19". */
  public static readonly VER_14_19 = AuroraPostgresEngineVersion.of(
    "14.19",
    "14",
    { s3Import: true, s3Export: true },
  );
  /** Version "14.20". */
  public static readonly VER_14_20 = AuroraPostgresEngineVersion.of(
    "14.20",
    "14",
    { s3Import: true, s3Export: true },
  );
  /** Version "14.22". */
  public static readonly VER_14_22 = AuroraPostgresEngineVersion.of(
    "14.22",
    "14",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_15_2 = AuroraPostgresEngineVersion.of(
    "15.2",
    "15",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_15_3 = AuroraPostgresEngineVersion.of(
    "15.3",
    "15",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_15_4 = AuroraPostgresEngineVersion.of(
    "15.4",
    "15",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_15_5 = AuroraPostgresEngineVersion.of(
    "15.5",
    "15",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_15_6 = AuroraPostgresEngineVersion.of(
    "15.6",
    "15",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_15_7 = AuroraPostgresEngineVersion.of(
    "15.7",
    "15",
    { s3Import: true, s3Export: true },
  );
  /** Version "15.8". */
  public static readonly VER_15_8 = AuroraPostgresEngineVersion.of(
    "15.8",
    "15",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_15_9 = AuroraPostgresEngineVersion.of(
    "15.9",
    "15",
    { s3Import: true, s3Export: true },
  );
  /** Version "15.10". */
  public static readonly VER_15_10 = AuroraPostgresEngineVersion.of(
    "15.10",
    "15",
    { s3Import: true, s3Export: true },
  );
  /** Version "15.12". */
  public static readonly VER_15_12 = AuroraPostgresEngineVersion.of(
    "15.12",
    "15",
    { s3Import: true, s3Export: true },
  );
  /** Version "15.13". */
  public static readonly VER_15_13 = AuroraPostgresEngineVersion.of(
    "15.13",
    "15",
    { s3Import: true, s3Export: true },
  );
  /** Version "15.14". */
  public static readonly VER_15_14 = AuroraPostgresEngineVersion.of(
    "15.14",
    "15",
    { s3Import: true, s3Export: true },
  );
  /** Version "15.15". */
  public static readonly VER_15_15 = AuroraPostgresEngineVersion.of(
    "15.15",
    "15",
    { s3Import: true, s3Export: true },
  );
  /** Version "15.17". */
  public static readonly VER_15_17 = AuroraPostgresEngineVersion.of(
    "15.17",
    "15",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_16_0 = AuroraPostgresEngineVersion.of(
    "16.0",
    "16",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_16_1 = AuroraPostgresEngineVersion.of(
    "16.1",
    "16",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_16_2 = AuroraPostgresEngineVersion.of(
    "16.2",
    "16",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_16_3 = AuroraPostgresEngineVersion.of(
    "16.3",
    "16",
    { s3Import: true, s3Export: true },
  );
  /** Version "16.4". */
  public static readonly VER_16_4 = AuroraPostgresEngineVersion.of(
    "16.4",
    "16",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_16_5 = AuroraPostgresEngineVersion.of(
    "16.5",
    "16",
    { s3Import: true, s3Export: true },
  );
  /** Version "16.6". */
  public static readonly VER_16_6 = AuroraPostgresEngineVersion.of(
    "16.6",
    "16",
    { s3Import: true, s3Export: true },
  );
  /** Version "16.6 limitless". */
  public static readonly VER_16_6_LIMITLESS = AuroraPostgresEngineVersion.of(
    "16.6-limitless",
    "16",
    { s3Import: true, s3Export: true },
  );
  /** Version "16.8". */
  public static readonly VER_16_8 = AuroraPostgresEngineVersion.of(
    "16.8",
    "16",
    { s3Import: true, s3Export: true },
  );
  /** Version "16.8 limitless". */
  public static readonly VER_16_8_LIMITLESS = AuroraPostgresEngineVersion.of(
    "16.8-limitless",
    "16",
    { s3Import: true, s3Export: true },
  );
  /** Version "16.9". */
  public static readonly VER_16_9 = AuroraPostgresEngineVersion.of(
    "16.9",
    "16",
    { s3Import: true, s3Export: true },
  );
  /** Version "16.9 limitless". */
  public static readonly VER_16_9_LIMITLESS = AuroraPostgresEngineVersion.of(
    "16.9-limitless",
    "16",
    { s3Import: true, s3Export: true },
  );
  /** Version "16.10". */
  public static readonly VER_16_10 = AuroraPostgresEngineVersion.of(
    "16.10",
    "16",
    { s3Import: true, s3Export: true },
  );
  /** Version "16.10 limitless". */
  public static readonly VER_16_10_LIMITLESS = AuroraPostgresEngineVersion.of(
    "16.10-limitless",
    "16",
    { s3Import: true, s3Export: true },
  );
  /** Version "16.11". */
  public static readonly VER_16_11 = AuroraPostgresEngineVersion.of(
    "16.11",
    "16",
    { s3Import: true, s3Export: true },
  );
  /** Version "16.11 limitless". */
  public static readonly VER_16_11_LIMITLESS = AuroraPostgresEngineVersion.of(
    "16.11-limitless",
    "16",
    { s3Import: true, s3Export: true },
  );
  /** Version "16.13". */
  public static readonly VER_16_13 = AuroraPostgresEngineVersion.of(
    "16.13",
    "16",
    { s3Import: true, s3Export: true },
  );
  /** Version "16.13 limitless". */
  public static readonly VER_16_13_LIMITLESS = AuroraPostgresEngineVersion.of(
    "16.13-limitless",
    "16",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_17_1 = AuroraPostgresEngineVersion.of(
    "17.1",
    "17",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_17_2 = AuroraPostgresEngineVersion.of(
    "17.2",
    "17",
    { s3Import: true, s3Export: true },
  );
  /** Version "17.4". */
  public static readonly VER_17_4 = AuroraPostgresEngineVersion.of(
    "17.4",
    "17",
    { s3Import: true, s3Export: true },
  );
  /** Version "17.5". */
  public static readonly VER_17_5 = AuroraPostgresEngineVersion.of(
    "17.5",
    "17",
    { s3Import: true, s3Export: true },
  );
  /** Version "17.6". */
  public static readonly VER_17_6 = AuroraPostgresEngineVersion.of(
    "17.6",
    "17",
    { s3Import: true, s3Export: true },
  );
  /** Version "17.7". */
  public static readonly VER_17_7 = AuroraPostgresEngineVersion.of(
    "17.7",
    "17",
    { s3Import: true, s3Export: true },
  );
  /** Version "17.9". */
  public static readonly VER_17_9 = AuroraPostgresEngineVersion.of(
    "17.9",
    "17",
    { s3Import: true, s3Export: true },
  );
  ...
  public static of(
    ...
    // Detects whether the auto-pause feature is supported.
    // https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-serverless-v2-auto-pause.html#auto-pause-prereqs
    const coercedVersion = semver.valid(
      semver.coerce(auroraPostgresFullVersion),
    );
    const serverlessV2AutoPauseSupported =
      coercedVersion != null &&
      semver.satisfies(coercedVersion, ">=16.3 || ^15.7 || ^14.12 || ^13.15");
  ...
  private constructor(
    ...
    this._features = {
      ...
      serverlessV2AutoPauseSupported:
        auroraPostgresFeatures?.serverlessV2AutoPauseSupported,
    };
  }
}
      ...
      features: version
        ? {
            ...
            s3Export: version._features.s3Export
              ...
              : undefined,
            serverlessV2AutoPauseSupported:
              version._features.serverlessV2AutoPauseSupported,
          }
        : {
...
export class DatabaseClusterEngine {
   ...
   */
  public static readonly AURORA_MYSQL: IClusterEngine =
    new AuroraMysqlClusterEngine();
   ...
   */
  public static readonly AURORA_POSTGRESQL: IClusterEngine =
    new AuroraPostgresClusterEngine();
