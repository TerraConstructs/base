// https://github.com/aws/aws-cdk/blob/v2.263.0/packages/aws-cdk-lib/aws-rds/lib/ca-certificate.ts
...
export class CaCertificate {
   ...
   */
  public static readonly RDS_CA_ECC384_G1 =
    CaCertificate.of("rds-ca-ecc384-g1");
   ...
   */
  public static readonly RDS_CA_RDS2048_G1 =
    CaCertificate.of("rds-ca-rsa2048-g1");

  /**
   * rds-ca-rsa2048-g1 certificate authority
   */
  public static readonly RDS_CA_RSA2048_G1 =
    CaCertificate.of("rds-ca-rsa2048-g1");
   ...
   */
  public static readonly RDS_CA_RDS4096_G1 =
    CaCertificate.of("rds-ca-rsa4096-g1");

  /**
   * rds-ca-rsa4096-g1 certificate authority
   */
  public static readonly RDS_CA_RSA4096_G1 =
    CaCertificate.of("rds-ca-rsa4096-g1");
