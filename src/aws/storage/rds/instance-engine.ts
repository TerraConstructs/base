// https://github.com/aws/aws-cdk/blob/v2.263.0/packages/aws-cdk-lib/aws-rds/lib/instance-engine.ts
...
export interface InstanceEngineBindOptions {
  ...
  // ARN-bearing supertype of `IRole`). `IRoleRef` is not ported here (base's `iam` module
  // hasn't landed the generated `iam.generated.ts` split), so this is typed against the
  // existing, broader `iam.IRole` instead. `IRole extends IRoleRef` upstream, so any real
  // caller passing a `Role`/`IRole` still satisfies this. See
  // https://github.com/aws/aws-cdk/blob/v2.263.0/packages/aws-cdk-lib/aws-rds/lib/instance-engine.ts#L34
...
interface InstanceEngineBaseProps {
  ...
  // `InstanceEngineBase` below for why that indirection is needed.
  readonly singleUserRotationApplication: () => secretsmanager.SecretRotationApplication;
  readonly multiUserRotationApplication: () => secretsmanager.SecretRotationApplication;
...
abstract class InstanceEngineBase implements IInstanceEngine {
  ...
  // as ordinary read-only properties on `IInstanceEngine` -- callers can't tell the difference --
  // and, crucially, lets `DatabaseInstanceEngine`'s unversioned convenience engines (e.g. `MARIADB`)
  // go back to being plain, eagerly-evaluated readonly static fields like upstream,
  // since constructing an `XInstanceEngine()` no longer touches `../../encryption` at all.
  ...
  public bindToInstance(
    ...
    if (options.timezone && !this.supportsTimezone) {
      throw new ValidationError(
        `timezone property can not be configured for ${this.engineType}`,
        scope,
      );
    }
    return {
...
export class MariaDbEngineVersion {
   ...
   * @deprecated MariaDB 10.0 is no longer supported by Amazon RDS.
   */
  public static readonly VER_10_0_17 = MariaDbEngineVersion.of(
    "10.0.17",
    "10.0",
  );
  /**
   ...
   * @deprecated MariaDB 10.0 is no longer supported by Amazon RDS.
   */
  public static readonly VER_10_0_24 = MariaDbEngineVersion.of(
    "10.0.24",
    "10.0",
  );
  /**
   ...
   * @deprecated MariaDB 10.0 is no longer supported by Amazon RDS.
   */
  public static readonly VER_10_0_28 = MariaDbEngineVersion.of(
    "10.0.28",
    "10.0",
  );
  /**
   ...
   * @deprecated MariaDB 10.0 is no longer supported by Amazon RDS.
   */
  public static readonly VER_10_0_31 = MariaDbEngineVersion.of(
    "10.0.31",
    "10.0",
  );
  /**
   ...
   * @deprecated MariaDB 10.0 is no longer supported by Amazon RDS.
   */
  public static readonly VER_10_0_32 = MariaDbEngineVersion.of(
    "10.0.32",
    "10.0",
  );
  /**
   ...
   * @deprecated MariaDB 10.0 is no longer supported by Amazon RDS.
   */
  public static readonly VER_10_0_34 = MariaDbEngineVersion.of(
    "10.0.34",
    "10.0",
  );
  /**
   ...
   * @deprecated MariaDB 10.0 is no longer supported by Amazon RDS.
   */
  public static readonly VER_10_0_35 = MariaDbEngineVersion.of(
    "10.0.35",
    "10.0",
  );
   ...
   * @deprecated MariaDB 10.1 is no longer supported by Amazon RDS.
   */
  public static readonly VER_10_1_14 = MariaDbEngineVersion.of(
    "10.1.14",
    "10.1",
  );
  /**
   ...
   * @deprecated MariaDB 10.1 is no longer supported by Amazon RDS.
   */
  public static readonly VER_10_1_19 = MariaDbEngineVersion.of(
    "10.1.19",
    "10.1",
  );
  /**
   ...
   * @deprecated MariaDB 10.1 is no longer supported by Amazon RDS.
   */
  public static readonly VER_10_1_23 = MariaDbEngineVersion.of(
    "10.1.23",
    "10.1",
  );
  /**
   ...
   * @deprecated MariaDB 10.1 is no longer supported by Amazon RDS.
   */
  public static readonly VER_10_1_26 = MariaDbEngineVersion.of(
    "10.1.26",
    "10.1",
  );
  /**
   ...
   * @deprecated MariaDB 10.1 is no longer supported by Amazon RDS.
   */
  public static readonly VER_10_1_31 = MariaDbEngineVersion.of(
    "10.1.31",
    "10.1",
  );
  /**
   ...
   * @deprecated MariaDB 10.1 is no longer supported by Amazon RDS.
   */
  public static readonly VER_10_1_34 = MariaDbEngineVersion.of(
    "10.1.34",
    "10.1",
  );
   ...
   * @deprecated MariaDB 10.2 is no longer supported by Amazon RDS.
   */
  public static readonly VER_10_2_11 = MariaDbEngineVersion.of(
    "10.2.11",
    "10.2",
  );
  /**
   ...
   * @deprecated MariaDB 10.2 is no longer supported by Amazon RDS.
   */
  public static readonly VER_10_2_12 = MariaDbEngineVersion.of(
    "10.2.12",
    "10.2",
  );
  /**
   ...
   * @deprecated MariaDB 10.2 is no longer supported by Amazon RDS.
   */
  public static readonly VER_10_2_15 = MariaDbEngineVersion.of(
    "10.2.15",
    "10.2",
  );
  /**
   ...
   * @deprecated MariaDB 10.2 is no longer supported by Amazon RDS.
   */
  public static readonly VER_10_2_21 = MariaDbEngineVersion.of(
    "10.2.21",
    "10.2",
  );
  /**
   ...
   * @deprecated MariaDB 10.2 is no longer supported by Amazon RDS.
   */
  public static readonly VER_10_2_32 = MariaDbEngineVersion.of(
    "10.2.32",
    "10.2",
  );
  /**
   ...
   * @deprecated MariaDB 10.2 is no longer supported by Amazon RDS.
   */
  public static readonly VER_10_2_37 = MariaDbEngineVersion.of(
    "10.2.37",
    "10.2",
  );
  /**
   ...
   * @deprecated MariaDB 10.2 is no longer supported by Amazon RDS.
   */
  public static readonly VER_10_2_39 = MariaDbEngineVersion.of(
    "10.2.39",
    "10.2",
  );
  /**
   ...
   * @deprecated MariaDB 10.2 is no longer supported by Amazon RDS.
   */
  public static readonly VER_10_2_40 = MariaDbEngineVersion.of(
    "10.2.40",
    "10.2",
  );
  /**
   ...
   * @deprecated MariaDB 10.2 is no longer supported by Amazon RDS.
   */
  public static readonly VER_10_2_41 = MariaDbEngineVersion.of(
    "10.2.41",
    "10.2",
  );
  /**
   ...
   */
  public static readonly VER_10_2_43 = MariaDbEngineVersion.of(
    "10.2.43",
    "10.2",
  );
  /**
   ...
   */
  public static readonly VER_10_2_44 = MariaDbEngineVersion.of(
    "10.2.44",
    "10.2",
  );
   ...
   */
  public static readonly VER_10_3_13 = MariaDbEngineVersion.of(
    "10.3.13",
    "10.3",
  );
  /**
   ...
   */
  public static readonly VER_10_3_20 = MariaDbEngineVersion.of(
    "10.3.20",
    "10.3",
  );
  /**
   ...
   */
  public static readonly VER_10_3_23 = MariaDbEngineVersion.of(
    "10.3.23",
    "10.3",
  );
  /**
   ...
   */
  public static readonly VER_10_3_28 = MariaDbEngineVersion.of(
    "10.3.28",
    "10.3",
  );
  /**
   ...
   */
  public static readonly VER_10_3_31 = MariaDbEngineVersion.of(
    "10.3.31",
    "10.3",
  );
  /**
   ...
   */
  public static readonly VER_10_3_32 = MariaDbEngineVersion.of(
    "10.3.32",
    "10.3",
  );
  /**
   ...
   */
  public static readonly VER_10_3_34 = MariaDbEngineVersion.of(
    "10.3.34",
    "10.3",
  );
  /**
   ...
   */
  public static readonly VER_10_3_35 = MariaDbEngineVersion.of(
    "10.3.35",
    "10.3",
  );
  /**
   ...
   */
  public static readonly VER_10_3_36 = MariaDbEngineVersion.of(
    "10.3.36",
    "10.3",
  );
  /**
   ...
   */
  public static readonly VER_10_3_37 = MariaDbEngineVersion.of(
    "10.3.37",
    "10.3",
  );
  /**
   ...
   */
  public static readonly VER_10_3_38 = MariaDbEngineVersion.of(
    "10.3.38",
    "10.3",
  );
  /**
   ...
   */
  public static readonly VER_10_3_39 = MariaDbEngineVersion.of(
    "10.3.39",
    "10.3",
  );
   ...
   */
  public static readonly VER_10_4_13 = MariaDbEngineVersion.of(
    "10.4.13",
    "10.4",
  );
  /**
   ...
   */
  public static readonly VER_10_4_18 = MariaDbEngineVersion.of(
    "10.4.18",
    "10.4",
  );
  /**
   ...
   */
  public static readonly VER_10_4_21 = MariaDbEngineVersion.of(
    "10.4.21",
    "10.4",
  );
  /**
   ...
   */
  public static readonly VER_10_4_22 = MariaDbEngineVersion.of(
    "10.4.22",
    "10.4",
  );
  /**
   ...
   */
  public static readonly VER_10_4_24 = MariaDbEngineVersion.of(
    "10.4.24",
    "10.4",
  );
  /**
   ...
   */
  public static readonly VER_10_4_25 = MariaDbEngineVersion.of(
    "10.4.25",
    "10.4",
  );
  /**
   ...
   */
  public static readonly VER_10_4_26 = MariaDbEngineVersion.of(
    "10.4.26",
    "10.4",
  );
  /**
   ...
   */
  public static readonly VER_10_4_27 = MariaDbEngineVersion.of(
    "10.4.27",
    "10.4",
  );
  /**
   ...
   */
  public static readonly VER_10_4_28 = MariaDbEngineVersion.of(
    "10.4.28",
    "10.4",
  );
  /**
   ...
   */
  public static readonly VER_10_4_29 = MariaDbEngineVersion.of(
    "10.4.29",
    "10.4",
  );
  /**
   ...
   */
  public static readonly VER_10_4_30 = MariaDbEngineVersion.of(
    "10.4.30",
    "10.4",
  );
  /**
   ...
   */
  public static readonly VER_10_4_31 = MariaDbEngineVersion.of(
    "10.4.31",
    "10.4",
  );
  /**
   ...
   */
  public static readonly VER_10_4_32 = MariaDbEngineVersion.of(
    "10.4.32",
    "10.4",
  );
  /**
   ...
   */
  public static readonly VER_10_4_33 = MariaDbEngineVersion.of(
    "10.4.33",
    "10.4",
  );
  /**
   ...
   */
  public static readonly VER_10_4_34 = MariaDbEngineVersion.of(
    "10.4.34",
    "10.4",
  );
   ...
   */
  public static readonly VER_10_5_12 = MariaDbEngineVersion.of(
    "10.5.12",
    "10.5",
  );
  /**
   ...
   */
  public static readonly VER_10_5_13 = MariaDbEngineVersion.of(
    "10.5.13",
    "10.5",
  );
  /**
   ...
   */
  public static readonly VER_10_5_15 = MariaDbEngineVersion.of(
    "10.5.15",
    "10.5",
  );
  /**
   ...
   */
  public static readonly VER_10_5_16 = MariaDbEngineVersion.of(
    "10.5.16",
    "10.5",
  );
  /**
   ...
   */
  public static readonly VER_10_5_17 = MariaDbEngineVersion.of(
    "10.5.17",
    "10.5",
  );
  /**
   ...
   */
  public static readonly VER_10_5_18 = MariaDbEngineVersion.of(
    "10.5.18",
    "10.5",
  );
  /**
   ...
   */
  public static readonly VER_10_5_19 = MariaDbEngineVersion.of(
    "10.5.19",
    "10.5",
  );
  /**
   ...
   */
  public static readonly VER_10_5_20 = MariaDbEngineVersion.of(
    "10.5.20",
    "10.5",
  );
  /**
   ...
   */
  public static readonly VER_10_5_21 = MariaDbEngineVersion.of(
    "10.5.21",
    "10.5",
  );
  /**
   ...
   */
  public static readonly VER_10_5_22 = MariaDbEngineVersion.of(
    "10.5.22",
    "10.5",
  );
  /**
   ...
   */
  public static readonly VER_10_5_23 = MariaDbEngineVersion.of(
    "10.5.23",
    "10.5",
  );
  /**
   ...
   */
  public static readonly VER_10_5_24 = MariaDbEngineVersion.of(
    "10.5.24",
    "10.5",
  );
  /**
   ...
   */
  public static readonly VER_10_5_25 = MariaDbEngineVersion.of(
    "10.5.25",
    "10.5",
  );
  /**
   ...
   */
  public static readonly VER_10_5_26 = MariaDbEngineVersion.of(
    "10.5.26",
    "10.5",
  );
  /** Version "10.5.27". */
  public static readonly VER_10_5_27 = MariaDbEngineVersion.of(
    "10.5.27",
    "10.5",
  );
  /** Version "10.5.28". */
  public static readonly VER_10_5_28 = MariaDbEngineVersion.of(
    "10.5.28",
    "10.5",
  );
  /** Version "10.5.29". */
  public static readonly VER_10_5_29 = MariaDbEngineVersion.of(
    "10.5.29",
    "10.5",
  );
   ...
   */
  public static readonly VER_10_6_10 = MariaDbEngineVersion.of(
    "10.6.10",
    "10.6",
  );
  /**
   ...
   */
  public static readonly VER_10_6_11 = MariaDbEngineVersion.of(
    "10.6.11",
    "10.6",
  );
  /**
   ...
   */
  public static readonly VER_10_6_12 = MariaDbEngineVersion.of(
    "10.6.12",
    "10.6",
  );
  /**
   ...
   */
  public static readonly VER_10_6_13 = MariaDbEngineVersion.of(
    "10.6.13",
    "10.6",
  );
  /**
   ...
   */
  public static readonly VER_10_6_14 = MariaDbEngineVersion.of(
    "10.6.14",
    "10.6",
  );
  /**
   ...
   */
  public static readonly VER_10_6_15 = MariaDbEngineVersion.of(
    "10.6.15",
    "10.6",
  );
  /**
   ...
   */
  public static readonly VER_10_6_16 = MariaDbEngineVersion.of(
    "10.6.16",
    "10.6",
  );
  /**
   ...
   */
  public static readonly VER_10_6_17 = MariaDbEngineVersion.of(
    "10.6.17",
    "10.6",
  );
  /**
   ...
   */
  public static readonly VER_10_6_18 = MariaDbEngineVersion.of(
    "10.6.18",
    "10.6",
  );
  /** Version "10.6.19". */
  public static readonly VER_10_6_19 = MariaDbEngineVersion.of(
    "10.6.19",
    "10.6",
  );
  /** Version "10.6.20". */
  public static readonly VER_10_6_20 = MariaDbEngineVersion.of(
    "10.6.20",
    "10.6",
  );
  /** Version "10.6.21". */
  public static readonly VER_10_6_21 = MariaDbEngineVersion.of(
    "10.6.21",
    "10.6",
  );
  /** Version "10.6.22". */
  public static readonly VER_10_6_22 = MariaDbEngineVersion.of(
    "10.6.22",
    "10.6",
  );
  /** Version "10.6.23". */
  public static readonly VER_10_6_23 = MariaDbEngineVersion.of(
    "10.6.23",
    "10.6",
  );
  /** Version "10.6.24". */
  public static readonly VER_10_6_24 = MariaDbEngineVersion.of(
    "10.6.24",
    "10.6",
  );
  /** Version "10.6.25". */
  public static readonly VER_10_6_25 = MariaDbEngineVersion.of(
    "10.6.25",
    "10.6",
  );
   ...
   */
  public static readonly VER_10_11_4 = MariaDbEngineVersion.of(
    "10.11.4",
    "10.11",
  );
  /**
   ...
   */
  public static readonly VER_10_11_5 = MariaDbEngineVersion.of(
    "10.11.5",
    "10.11",
  );
  /**
   ...
   */
  public static readonly VER_10_11_6 = MariaDbEngineVersion.of(
    "10.11.6",
    "10.11",
  );
  /**
   ...
   */
  public static readonly VER_10_11_7 = MariaDbEngineVersion.of(
    "10.11.7",
    "10.11",
  );
  /**
   ...
   */
  public static readonly VER_10_11_8 = MariaDbEngineVersion.of(
    "10.11.8",
    "10.11",
  );
  /** Version "10.11.9". */
  public static readonly VER_10_11_9 = MariaDbEngineVersion.of(
    "10.11.9",
    "10.11",
  );
  /** Version "10.11.10". */
  public static readonly VER_10_11_10 = MariaDbEngineVersion.of(
    "10.11.10",
    "10.11",
  );
  /** Version "10.11.11". */
  public static readonly VER_10_11_11 = MariaDbEngineVersion.of(
    "10.11.11",
    "10.11",
  );
  /** Version "10.11.13". */
  public static readonly VER_10_11_13 = MariaDbEngineVersion.of(
    "10.11.13",
    "10.11",
  );
  /** Version "10.11.14". */
  public static readonly VER_10_11_14 = MariaDbEngineVersion.of(
    "10.11.14",
    "10.11",
  );
  /** Version "10.11.15". */
  public static readonly VER_10_11_15 = MariaDbEngineVersion.of(
    "10.11.15",
    "10.11",
  );
  /** Version "10.11.16". */
  public static readonly VER_10_11_16 = MariaDbEngineVersion.of(
    "10.11.16",
    "10.11",
  );
  ...
  /** Version "11.4.10". */
  public static readonly VER_11_4_10 = MariaDbEngineVersion.of(
    "11.4.10",
    "11.4",
  );
...
class MariaDbInstanceEngine extends InstanceEngineBase {
  ...
  public bindToInstance(
    ...
    if (options.domain) {
      throw new ValidationError(
        `domain property cannot be configured for ${this.engineType}`,
        scope,
      );
    }
...
export class MysqlEngineVersion {
   ...
   */
  public static readonly VER_5_7_44_RDS_20250103 = MysqlEngineVersion.of(
    "5.7.44-rds.20250103",
    "5.7",
  );
  /** Version "5.7.44-rds.20250213". */
  public static readonly VER_5_7_44_RDS_20250213 = MysqlEngineVersion.of(
    "5.7.44-rds.20250213",
    "5.7",
  );
  /** Version "5.7.44-rds.20250508". */
  public static readonly VER_5_7_44_RDS_20250508 = MysqlEngineVersion.of(
    "5.7.44-rds.20250508",
    "5.7",
  );
  /** Version "5.7.44-rds.20250818". */
  public static readonly VER_5_7_44_RDS_20250818 = MysqlEngineVersion.of(
    "5.7.44-rds.20250818",
    "5.7",
  );
  /** Version "5.7.44-rds.20251212". */
  public static readonly VER_5_7_44_RDS_20251212 = MysqlEngineVersion.of(
    "5.7.44-rds.20251212",
    "5.7",
  );
  /** Version "5.7.44-rds.20260212". */
  public static readonly VER_5_7_44_RDS_20260212 = MysqlEngineVersion.of(
    "5.7.44-rds.20260212",
    "5.7",
  );
  /** Version "5.7.44-rds.20260521". */
  public static readonly VER_5_7_44_RDS_20260521 = MysqlEngineVersion.of(
    "5.7.44-rds.20260521",
    "5.7",
  );
...
export class PostgresEngineVersion {
   ...
   */
  public static readonly VER_11_22_RDS_20250220 = PostgresEngineVersion.of(
    "11.22-rds.20250220",
    "11",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_11_22_RDS_20250508 = PostgresEngineVersion.of(
    "11.22-rds.20250508",
    "11",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_11_22_RDS_20250814 = PostgresEngineVersion.of(
    "11.22-rds.20250814",
    "11",
    { s3Import: true, s3Export: true },
  );
  /** Version "11.22-rds.20251114". */
  public static readonly VER_11_22_RDS_20251114 = PostgresEngineVersion.of(
    "11.22-rds.20251114",
    "11",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_12_22_RDS_20250220 = PostgresEngineVersion.of(
    "12.22-rds.20250220",
    "12",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_12_22_RDS_20250508 = PostgresEngineVersion.of(
    "12.22-rds.20250508",
    "12",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_12_22_RDS_20250814 = PostgresEngineVersion.of(
    "12.22-rds.20250814",
    "12",
    { s3Import: true, s3Export: true },
  );
  /** Version "12.22-rds.20251114". */
  public static readonly VER_12_22_RDS_20251114 = PostgresEngineVersion.of(
    "12.22-rds.20251114",
    "12",
    { s3Import: true, s3Export: true },
  );
   ...
   */
  public static readonly VER_13_19 = PostgresEngineVersion.of("13.19", "13", {
    s3Import: true,
    s3Export: true,
  });
  /** Version "13.20". */
  public static readonly VER_13_20 = PostgresEngineVersion.of("13.20", "13", {
    s3Import: true,
    s3Export: true,
  });
  /** Version "13.21". */
  public static readonly VER_13_21 = PostgresEngineVersion.of("13.21", "13", {
    s3Import: true,
    s3Export: true,
  });
  /** Version "13.22". */
  public static readonly VER_13_22 = PostgresEngineVersion.of("13.22", "13", {
    s3Import: true,
    s3Export: true,
  });
  /** Version "13.23". */
  public static readonly VER_13_23 = PostgresEngineVersion.of("13.23", "13", {
    s3Import: true,
    s3Export: true,
  });
   ...
   */
  public static readonly VER_14_16 = PostgresEngineVersion.of("14.16", "14", {
    s3Import: true,
    s3Export: true,
  });
  /** Version "14.17". */
  public static readonly VER_14_17 = PostgresEngineVersion.of("14.17", "14", {
    s3Import: true,
    s3Export: true,
  });
  /** Version "14.18". */
  public static readonly VER_14_18 = PostgresEngineVersion.of("14.18", "14", {
    s3Import: true,
    s3Export: true,
  });
  /** Version "14.19". */
  public static readonly VER_14_19 = PostgresEngineVersion.of("14.19", "14", {
    s3Import: true,
    s3Export: true,
  });
  /** Version "14.20". */
  public static readonly VER_14_20 = PostgresEngineVersion.of("14.20", "14", {
    s3Import: true,
    s3Export: true,
  });
  /** Version "14.21". */
  public static readonly VER_14_21 = PostgresEngineVersion.of("14.21", "14", {
    s3Import: true,
    s3Export: true,
  });
  /** Version "14.22". */
  public static readonly VER_14_22 = PostgresEngineVersion.of("14.22", "14", {
    s3Import: true,
    s3Export: true,
  });
   ...
   */
  public static readonly VER_15_11 = PostgresEngineVersion.of("15.11", "15", {
    s3Import: true,
    s3Export: true,
  });
  /** Version "15.12". */
  public static readonly VER_15_12 = PostgresEngineVersion.of("15.12", "15", {
    s3Import: true,
    s3Export: true,
  });
  /** Version "15.13". */
  public static readonly VER_15_13 = PostgresEngineVersion.of("15.13", "15", {
    s3Import: true,
    s3Export: true,
  });
  /** Version "15.14". */
  public static readonly VER_15_14 = PostgresEngineVersion.of("15.14", "15", {
    s3Import: true,
    s3Export: true,
  });
  /** Version "15.15". */
  public static readonly VER_15_15 = PostgresEngineVersion.of("15.15", "15", {
    s3Import: true,
    s3Export: true,
  });
  /** Version "15.16". */
  public static readonly VER_15_16 = PostgresEngineVersion.of("15.16", "15", {
    s3Import: true,
    s3Export: true,
  });
  /** Version "15.17". */
  public static readonly VER_15_17 = PostgresEngineVersion.of("15.17", "15", {
    s3Import: true,
    s3Export: true,
  });
   ...
   */
  public static readonly VER_16_7 = PostgresEngineVersion.of("16.7", "16", {
    s3Import: true,
    s3Export: true,
  });
  /** Version "16.8". */
  public static readonly VER_16_8 = PostgresEngineVersion.of("16.8", "16", {
    s3Import: true,
    s3Export: true,
  });
  /** Version "16.9". */
  public static readonly VER_16_9 = PostgresEngineVersion.of("16.9", "16", {
    s3Import: true,
    s3Export: true,
  });
  /** Version "16.10". */
  public static readonly VER_16_10 = PostgresEngineVersion.of("16.10", "16", {
    s3Import: true,
    s3Export: true,
  });
  /** Version "16.11". */
  public static readonly VER_16_11 = PostgresEngineVersion.of("16.11", "16", {
    s3Import: true,
    s3Export: true,
  });
  /** Version "16.12". */
  public static readonly VER_16_12 = PostgresEngineVersion.of("16.12", "16", {
    s3Import: true,
    s3Export: true,
  });
  /** Version "16.13". */
  public static readonly VER_16_13 = PostgresEngineVersion.of("16.13", "16", {
    s3Import: true,
    s3Export: true,
  });
   ...
   */
  public static readonly VER_17_3 = PostgresEngineVersion.of("17.3", "17", {
    s3Import: true,
    s3Export: true,
  });
  /** Version "17.4". */
  public static readonly VER_17_4 = PostgresEngineVersion.of("17.4", "17", {
    s3Import: true,
    s3Export: true,
  });
  /** Version "17.5". */
  public static readonly VER_17_5 = PostgresEngineVersion.of("17.5", "17", {
    s3Import: true,
    s3Export: true,
  });
  /** Version "17.6". */
  public static readonly VER_17_6 = PostgresEngineVersion.of("17.6", "17", {
    s3Import: true,
    s3Export: true,
  });
  /** Version "17.7". */
  public static readonly VER_17_7 = PostgresEngineVersion.of("17.7", "17", {
    s3Import: true,
    s3Export: true,
  });
  /** Version "17.8". */
  public static readonly VER_17_8 = PostgresEngineVersion.of("17.8", "17", {
    s3Import: true,
    s3Export: true,
  });
  /** Version "17.9". */
  public static readonly VER_17_9 = PostgresEngineVersion.of("17.9", "17", {
    s3Import: true,
    s3Export: true,
  });

  /** Version "18" (only a major version, without a specific minor version). */
  public static readonly VER_18 = PostgresEngineVersion.of("18", "18", {
    s3Import: true,
    s3Export: true,
  });
  /** Version "18.1". */
  public static readonly VER_18_1 = PostgresEngineVersion.of("18.1", "18", {
    s3Import: true,
    s3Export: true,
  });
  /** Version "18.2". */
  public static readonly VER_18_2 = PostgresEngineVersion.of("18.2", "18", {
    s3Import: true,
    s3Export: true,
  });
  /** Version "18.3". */
  public static readonly VER_18_3 = PostgresEngineVersion.of("18.3", "18", {
    s3Import: true,
    s3Export: true,
  });
...
export class OracleLegacyEngineVersion {
  ...
  public static readonly VER_11_2 = OracleLegacyEngineVersion.of(
    "11.2",
    "11.2",
  );
  /** Version "11.2.0.2.v2". */
  public static readonly VER_11_2_0_2_V2 = OracleLegacyEngineVersion.of(
    "11.2.0.2.v2",
    "11.2",
  );
  /** Version "11.2.0.4.v1". */
  public static readonly VER_11_2_0_4_V1 = OracleLegacyEngineVersion.of(
    "11.2.0.4.v1",
    "11.2",
  );
  /** Version "11.2.0.4.v3". */
  public static readonly VER_11_2_0_4_V3 = OracleLegacyEngineVersion.of(
    "11.2.0.4.v3",
    "11.2",
  );
  /** Version "11.2.0.4.v4". */
  public static readonly VER_11_2_0_4_V4 = OracleLegacyEngineVersion.of(
    "11.2.0.4.v4",
    "11.2",
  );
  /** Version "11.2.0.4.v5". */
  public static readonly VER_11_2_0_4_V5 = OracleLegacyEngineVersion.of(
    "11.2.0.4.v5",
    "11.2",
  );
  /** Version "11.2.0.4.v6". */
  public static readonly VER_11_2_0_4_V6 = OracleLegacyEngineVersion.of(
    "11.2.0.4.v6",
    "11.2",
  );
  /** Version "11.2.0.4.v7". */
  public static readonly VER_11_2_0_4_V7 = OracleLegacyEngineVersion.of(
    "11.2.0.4.v7",
    "11.2",
  );
  /** Version "11.2.0.4.v8". */
  public static readonly VER_11_2_0_4_V8 = OracleLegacyEngineVersion.of(
    "11.2.0.4.v8",
    "11.2",
  );
  /** Version "11.2.0.4.v9". */
  public static readonly VER_11_2_0_4_V9 = OracleLegacyEngineVersion.of(
    "11.2.0.4.v9",
    "11.2",
  );
  /** Version "11.2.0.4.v10". */
  public static readonly VER_11_2_0_4_V10 = OracleLegacyEngineVersion.of(
    "11.2.0.4.v10",
    "11.2",
  );
  /** Version "11.2.0.4.v11". */
  public static readonly VER_11_2_0_4_V11 = OracleLegacyEngineVersion.of(
    "11.2.0.4.v11",
    "11.2",
  );
  /** Version "11.2.0.4.v12". */
  public static readonly VER_11_2_0_4_V12 = OracleLegacyEngineVersion.of(
    "11.2.0.4.v12",
    "11.2",
  );
  /** Version "11.2.0.4.v13". */
  public static readonly VER_11_2_0_4_V13 = OracleLegacyEngineVersion.of(
    "11.2.0.4.v13",
    "11.2",
  );
  /** Version "11.2.0.4.v14". */
  public static readonly VER_11_2_0_4_V14 = OracleLegacyEngineVersion.of(
    "11.2.0.4.v14",
    "11.2",
  );
  /** Version "11.2.0.4.v15". */
  public static readonly VER_11_2_0_4_V15 = OracleLegacyEngineVersion.of(
    "11.2.0.4.v15",
    "11.2",
  );
  /** Version "11.2.0.4.v16". */
  public static readonly VER_11_2_0_4_V16 = OracleLegacyEngineVersion.of(
    "11.2.0.4.v16",
    "11.2",
  );
  /** Version "11.2.0.4.v17". */
  public static readonly VER_11_2_0_4_V17 = OracleLegacyEngineVersion.of(
    "11.2.0.4.v17",
    "11.2",
  );
  /** Version "11.2.0.4.v18". */
  public static readonly VER_11_2_0_4_V18 = OracleLegacyEngineVersion.of(
    "11.2.0.4.v18",
    "11.2",
  );
  /** Version "11.2.0.4.v19". */
  public static readonly VER_11_2_0_4_V19 = OracleLegacyEngineVersion.of(
    "11.2.0.4.v19",
    "11.2",
  );
  /** Version "11.2.0.4.v20". */
  public static readonly VER_11_2_0_4_V20 = OracleLegacyEngineVersion.of(
    "11.2.0.4.v20",
    "11.2",
  );
  /** Version "11.2.0.4.v21". */
  public static readonly VER_11_2_0_4_V21 = OracleLegacyEngineVersion.of(
    "11.2.0.4.v21",
    "11.2",
  );
  /** Version "11.2.0.4.v22". */
  public static readonly VER_11_2_0_4_V22 = OracleLegacyEngineVersion.of(
    "11.2.0.4.v22",
    "11.2",
  );
  /** Version "11.2.0.4.v23". */
  public static readonly VER_11_2_0_4_V23 = OracleLegacyEngineVersion.of(
    "11.2.0.4.v23",
    "11.2",
  );
  /** Version "11.2.0.4.v24". */
  public static readonly VER_11_2_0_4_V24 = OracleLegacyEngineVersion.of(
    "11.2.0.4.v24",
    "11.2",
  );
  /** Version "11.2.0.4.v25". */
  public static readonly VER_11_2_0_4_V25 = OracleLegacyEngineVersion.of(
    "11.2.0.4.v25",
    "11.2",
  );
  ...
  private static of(
    ...
    return new OracleLegacyEngineVersion(
...
export class OracleEngineVersion {
   ...
   */
  public static readonly VER_12_1_0_2_V1 = OracleEngineVersion.of(
    "12.1.0.2.v1",
    "12.1",
  );
  /**
   ...
   */
  public static readonly VER_12_1_0_2_V2 = OracleEngineVersion.of(
    "12.1.0.2.v2",
    "12.1",
  );
  /**
   ...
   */
  public static readonly VER_12_1_0_2_V3 = OracleEngineVersion.of(
    "12.1.0.2.v3",
    "12.1",
  );
  /**
   ...
   */
  public static readonly VER_12_1_0_2_V4 = OracleEngineVersion.of(
    "12.1.0.2.v4",
    "12.1",
  );
  /**
   ...
   */
  public static readonly VER_12_1_0_2_V5 = OracleEngineVersion.of(
    "12.1.0.2.v5",
    "12.1",
  );
  /**
   ...
   */
  public static readonly VER_12_1_0_2_V6 = OracleEngineVersion.of(
    "12.1.0.2.v6",
    "12.1",
  );
  /**
   ...
   */
  public static readonly VER_12_1_0_2_V7 = OracleEngineVersion.of(
    "12.1.0.2.v7",
    "12.1",
  );
  /**
   ...
   */
  public static readonly VER_12_1_0_2_V8 = OracleEngineVersion.of(
    "12.1.0.2.v8",
    "12.1",
  );
  /**
   ...
   */
  public static readonly VER_12_1_0_2_V9 = OracleEngineVersion.of(
    "12.1.0.2.v9",
    "12.1",
  );
  /**
   ...
   */
  public static readonly VER_12_1_0_2_V10 = OracleEngineVersion.of(
    "12.1.0.2.v10",
    "12.1",
  );
  /**
   ...
   */
  public static readonly VER_12_1_0_2_V11 = OracleEngineVersion.of(
    "12.1.0.2.v11",
    "12.1",
  );
  /**
   ...
   */
  public static readonly VER_12_1_0_2_V12 = OracleEngineVersion.of(
    "12.1.0.2.v12",
    "12.1",
  );
  /**
   ...
   */
  public static readonly VER_12_1_0_2_V13 = OracleEngineVersion.of(
    "12.1.0.2.v13",
    "12.1",
  );
  /**
   ...
   */
  public static readonly VER_12_1_0_2_V14 = OracleEngineVersion.of(
    "12.1.0.2.v14",
    "12.1",
  );
  /**
   ...
   */
  public static readonly VER_12_1_0_2_V15 = OracleEngineVersion.of(
    "12.1.0.2.v15",
    "12.1",
  );
  /**
   ...
   */
  public static readonly VER_12_1_0_2_V16 = OracleEngineVersion.of(
    "12.1.0.2.v16",
    "12.1",
  );
  /**
   ...
   */
  public static readonly VER_12_1_0_2_V17 = OracleEngineVersion.of(
    "12.1.0.2.v17",
    "12.1",
  );
  /**
   ...
   */
  public static readonly VER_12_1_0_2_V18 = OracleEngineVersion.of(
    "12.1.0.2.v18",
    "12.1",
  );
  /**
   ...
   */
  public static readonly VER_12_1_0_2_V19 = OracleEngineVersion.of(
    "12.1.0.2.v19",
    "12.1",
  );
  /**
   ...
   */
  public static readonly VER_12_1_0_2_V20 = OracleEngineVersion.of(
    "12.1.0.2.v20",
    "12.1",
  );
  /**
   ...
   */
  public static readonly VER_12_1_0_2_V21 = OracleEngineVersion.of(
    "12.1.0.2.v21",
    "12.1",
  );
  /**
   ...
   */
  public static readonly VER_12_1_0_2_V22 = OracleEngineVersion.of(
    "12.1.0.2.v22",
    "12.1",
  );
  /**
   ...
   */
  public static readonly VER_12_1_0_2_V23 = OracleEngineVersion.of(
    "12.1.0.2.v23",
    "12.1",
  );
  /**
   ...
   */
  public static readonly VER_12_1_0_2_V24 = OracleEngineVersion.of(
    "12.1.0.2.v24",
    "12.1",
  );
  /**
   ...
   */
  public static readonly VER_12_1_0_2_V25 = OracleEngineVersion.of(
    "12.1.0.2.v25",
    "12.1",
  );
  /**
   ...
   */
  public static readonly VER_12_1_0_2_V26 = OracleEngineVersion.of(
    "12.1.0.2.v26",
    "12.1",
  );
  /**
   ...
   */
  public static readonly VER_12_1_0_2_V27 = OracleEngineVersion.of(
    "12.1.0.2.v27",
    "12.1",
  );
  /**
   ...
   */
  public static readonly VER_12_1_0_2_V28 = OracleEngineVersion.of(
    "12.1.0.2.v28",
    "12.1",
  );
  /**
   ...
   */
  public static readonly VER_12_1_0_2_V29 = OracleEngineVersion.of(
    "12.1.0.2.v29",
    "12.1",
  );
  ...
  public static readonly VER_19_0_0_0_2025_01_R1 = OracleEngineVersion.of(
    "19.0.0.0.ru-2025-01.rur-2025-01.r1",
    "19",
  );
  /** Version "19.0.0.0.ru-2025-07.rur-2025-07.r1". */
  public static readonly VER_19_0_0_0_2025_07_R1 = OracleEngineVersion.of(
  ...
  public static readonly VER_21_0_0_0_2025_01_R1 = OracleEngineVersion.of(
    "21.0.0.0.ru-2025-01.rur-2025-01.r1",
    "21",
  );
  /** Version "21.0.0.0.ru-2025-07.rur-2025-07.r1". */
  public static readonly VER_21_0_0_0_2025_07_R1 = OracleEngineVersion.of(
    "21.0.0.0.ru-2025-07.rur-2025-07.r1",
    "21",
  );
...
export interface OracleSe2InstanceEngineProps
  extends OracleInstanceEngineProps {}
 ...
 */
export interface OracleSe2CdbInstanceEngineProps
  extends OracleInstanceEngineProps {}
 ...
 */
export interface OracleEeCdbInstanceEngineProps
  extends OracleInstanceEngineProps {}
...
export class SqlServerEngineVersion {
  ...
  public static readonly VER_13_00_6460_7_V1 = SqlServerEngineVersion.of(
    "13.00.6460.7.v1",
    "13.00",
  );
  /** Version "13.00.6465.1.v1". */
  public static readonly VER_13_00_6465_1_V1 = SqlServerEngineVersion.of(
    "13.00.6465.1.v1",
    "13.00",
  );
  /** Version "13.00.6470.1.v1". */
  public static readonly VER_13_00_6470_1_V1 = SqlServerEngineVersion.of(
    "13.00.6470.1.v1",
    "13.00",
  );
  ...
  public static readonly VER_14_00_3495_9_V1 = SqlServerEngineVersion.of(
    "14.00.3495.9.v1",
    "14.00",
  );
  /** Version "14.00.3500.1.v1". */
  public static readonly VER_14_00_3500_1_V1 = SqlServerEngineVersion.of(
    "14.00.3500.1.v1",
    "14.00",
  );
  /** Version "14.00.3505.1.v1". */
  public static readonly VER_14_00_3505_1_V1 = SqlServerEngineVersion.of(
    "14.00.3505.1.v1",
    "14.00",
  );
  ...
  public static readonly VER_15_00_4415_2_V1 = SqlServerEngineVersion.of(
    "15.00.4415.2.v1",
    "15.00",
  );
  /** Version "15.00.4420.2.v1". */
  public static readonly VER_15_00_4420_2_V1 = SqlServerEngineVersion.of(
    "15.00.4420.2.v1",
    "15.00",
  );
  /** Version "15.00.4430.1.v1". */
  public static readonly VER_15_00_4430_1_V1 = SqlServerEngineVersion.of(
    "15.00.4430.1.v1",
    "15.00",
  );
  /** Version "15.00.4435.7.v1". */
  public static readonly VER_15_00_4435_7_V1 = SqlServerEngineVersion.of(
    "15.00.4435.7.v1",
    "15.00",
  );
  /** Version "15.00.4440.1.v1". */
  public static readonly VER_15_00_4440_1_V1 = SqlServerEngineVersion.of(
    "15.00.4440.1.v1",
    "15.00",
  );
  /** Version "15.00.4445.1.v1". */
  public static readonly VER_15_00_4445_1_V1 = SqlServerEngineVersion.of(
    "15.00.4445.1.v1",
    "15.00",
  );
  /** Version "15.00.4455.2.v1". */
  public static readonly VER_15_00_4455_2_V1 = SqlServerEngineVersion.of(
    "15.00.4455.2.v1",
    "15.00",
  );
  ...
  public static readonly VER_16_00_4175_1_V1 = SqlServerEngineVersion.of(
    "16.00.4175.1.v1",
    "16.00",
  );
  /** Version "16.00.4185.3.v1". */
  public static readonly VER_16_00_4185_3_V1 = SqlServerEngineVersion.of(
    "16.00.4185.3.v1",
    "16.00",
  );
  /** Version "16.00.4195.2.v1". */
  public static readonly VER_16_00_4195_2_V1 = SqlServerEngineVersion.of(
    "16.00.4195.2.v1",
    "16.00",
  );
  /** Version "16.00.4205.1.v1". */
  public static readonly VER_16_00_4205_1_V1 = SqlServerEngineVersion.of(
    "16.00.4205.1.v1",
    "16.00",
  );
  /** Version "16.00.4210.1.v1". */
  public static readonly VER_16_00_4210_1_V1 = SqlServerEngineVersion.of(
    "16.00.4210.1.v1",
    "16.00",
  );
  /** Version "16.00.4215.2.v1". */
  public static readonly VER_16_00_4215_2_V1 = SqlServerEngineVersion.of(
    "16.00.4215.2.v1",
    "16.00",
  );
  /** Version "16.00.4225.2.v1". */
  public static readonly VER_16_00_4225_2_V1 = SqlServerEngineVersion.of(
    "16.00.4225.2.v1",
    "16.00",
  );
  /** Version "16.00.4230.2.v1". */
  public static readonly VER_16_00_4230_2_V1 = SqlServerEngineVersion.of(
    "16.00.4230.2.v1",
    "16.00",
  );
  /** Version "16.00.4236.2.v1". */
  public static readonly VER_16_00_4236_2_V1 = SqlServerEngineVersion.of(
    "16.00.4236.2.v1",
    "16.00",
  );
  ...
  public bindToInstance(
    ...
    if (s3Role) {
      if (
        ...
        throw new ValidationError(
          "S3 import and export roles must be the same for SQL Server engines",
          scope,
        );
      }
      ...
      optionGroup.addConfiguration({
        ...
        // TERRACONSTRUCTS DEVIATION: `s3Role` is typed as `iam.IRole` here (see the
        // `s3ImportRole`/`s3ExportRole` deviation note above), which exposes `roleArn`
        // directly instead of upstream's `iam.IRoleRef.roleRef.roleArn` indirection.
...
export interface SqlServerSeInstanceEngineProps
  extends SqlServerInstanceEngineProps {}
...
export class DatabaseInstanceEngine {
   ...
   */
  public static readonly ORACLE_EE: IInstanceEngine =
   ...
   */
  public static readonly ORACLE_EE_CDB: IInstanceEngine =
    new OracleEeCdbInstanceEngine();
   ...
   */
  public static readonly ORACLE_SE2: IInstanceEngine =
    new OracleSe2InstanceEngine();
   ...
   */
  public static readonly ORACLE_SE2_CDB: IInstanceEngine =
    new OracleSe2CdbInstanceEngine();
   ...
   * @deprecated instances can no longer be created with this engine. See https://forums.aws.amazon.com/ann.jspa?annID=7341
   */
  public static readonly ORACLE_SE1: IInstanceEngine =
    new OracleSe1InstanceEngine();
   ...
   * @deprecated instances can no longer be created with this engine. See https://forums.aws.amazon.com/ann.jspa?annID=7341
   */
  public static readonly ORACLE_SE: IInstanceEngine =
    new OracleSeInstanceEngine();
   ...
   */
  public static readonly POSTGRES: IInstanceEngine =
    new PostgresInstanceEngine();
   ...
   */
  public static readonly SQL_SERVER_EE: IInstanceEngine =
    new SqlServerEeInstanceEngine();
   ...
   */
  public static readonly SQL_SERVER_SE: IInstanceEngine =
    new SqlServerSeInstanceEngine();
   ...
   */
  public static readonly SQL_SERVER_EX: IInstanceEngine =
    new SqlServerExInstanceEngine();
   ...
   */
  public static readonly SQL_SERVER_WEB: IInstanceEngine =
