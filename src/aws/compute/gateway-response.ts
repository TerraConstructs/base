 ...
 */
export interface IGatewayResponse extends IAwsConstruct {}
...
{
  public readonly resource: apiGatewayGatewayResponse.ApiGatewayGatewayResponse;

  public get outputs(): Record<string, any> {
    return {
      // GatewayResponse itself doesn't have specific outputs like ARN or ID in the same way other resources might.
      // The underlying Terraform resource has an 'id' which is typically rest_api_id/response_type.
      responseType: this.resource.responseType,
      restApiId: this.resource.restApiId,
    };
  }
  ...
  constructor(scope: Construct, id: string, props: GatewayResponseProps) {
    ...
    const gatewayResponseProps: apiGatewayGatewayResponse.ApiGatewayGatewayResponseConfig =
      {
    ...
    this.resource = new apiGatewayGatewayResponse.ApiGatewayGatewayResponse(
      this,
      "Resource",
    ...
    if (deployment) {
      ...
      deployment.addToTriggers(gatewayResponseProps);
    }
  }
...
export class ResponseType {
   ...
   */
  public static readonly API_CONFIGURATION_ERROR = new ResponseType(
   ...
   */
  public static readonly AUTHORIZER_FAILURE = new ResponseType(
    "AUTHORIZER_FAILURE",
  );
   ...
   */
  public static readonly BAD_REQUEST_PARAMETERS = new ResponseType(
   ...
   */
  public static readonly BAD_REQUEST_BODY = new ResponseType(
    "BAD_REQUEST_BODY",
  );
   ...
   */
  public static readonly INVALID_SIGNATURE = new ResponseType(
    "INVALID_SIGNATURE",
  );
   ...
   */
  public static readonly INTEGRATION_FAILURE = new ResponseType(
    "INTEGRATION_FAILURE",
  );
   ...
   */
  public static readonly INTEGRATION_TIMEOUT = new ResponseType(
    "INTEGRATION_TIMEOUT",
  );
   ...
   */
  public static readonly REQUEST_TOO_LARGE = new ResponseType(
    "REQUEST_TOO_LARGE",
  );
   ...
   */
  public static readonly RESOURCE_NOT_FOUND = new ResponseType(
    "RESOURCE_NOT_FOUND",
  );
   ...
   */
  public static readonly UNSUPPORTED_MEDIA_TYPE = new ResponseType(
