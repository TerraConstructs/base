 ...
 */
export class ApplicationTargetGroup
  ...
  implements IApplicationTargetGroup
{
  ...
  constructor(
    ...
    if (props) {
      ...
      if (props.slowStart !== undefined) {
        ...
        if (
          (props.slowStart.toSeconds() < 30 &&
            props.slowStart.toSeconds() !== 0) ||
        ...
        this.setAttribute(
          ...
          props.slowStart.toSeconds().toString(),
        );
      ...
      if (props.stickinessCookieDuration) {
        this.enableCookieStickiness(
          props.stickinessCookieDuration,
          props.stickinessCookieName,
        );
      } else {
   ...
   */
  public registerConnectable(connectable: IConnectable, portRange?: Port) {
    portRange = portRange || Port.tcp(this.defaultPort);
  ...
  protected validateTargetGroup(): string[] {
    ...
    if (
      ...
      ret.push(
        "At least one of 'port' or 'protocol' is required for a non-Lambda TargetGroup",
      );
    }
    ...
    if (this.healthCheck) {
      if (
        ...
        this.healthCheck.interval.toMilliseconds() <=
          this.healthCheck.timeout.toMilliseconds()
      ) {
        ret.push(
  ...
  implements IApplicationTargetGroup
{
  ...
  public registerListener(
    _listener: IApplicationListener,
    _associatingConstruct?: IConstruct,
  ) {
  ...
  public registerConnectable(
    _connectable: IConnectable,
    _portRange?: Port | undefined,
  ): void {
...
const ALB_HEALTH_CHECK_PROTOCOLS = [LbProtocol.HTTP, LbProtocol.HTTPS];
