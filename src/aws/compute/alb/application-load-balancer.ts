...
import { PolicyStatement } from "../../iam/policy-statement";
import { ServicePrincipal } from "../../iam/principals";
  ...
  implements IApplicationLoadBalancer
{
  ...
  constructor(
    ...
    const securityGroups = [
      props.securityGroup ||
        new SecurityGroup(this, "SecurityGroup", {
          vpc: props.vpc,
          description: `Automatically created Security Group for ELB ${AwsStack.uniqueId(this)}`,
    ...
    if (props.http2Enabled !== undefined) {
      this.setAttribute(
        ...
        props.http2Enabled ? "true" : "false",
      );
    }
    if (props.idleTimeout !== undefined) {
      this.setAttribute(
        "idle_timeout.timeout_seconds",
        props.idleTimeout.toSeconds().toString(),
      );
    }
    ...
    if (props.clientKeepAlive !== undefined) {
      ...
      this.setAttribute(
        ...
        clientKeepAliveInSeconds.toString(),
      );
    }
   ...
   */
  public metricClientTlsNegotiationErrorCount(
    props?: cloudwatch.MetricOptions,
  ) {
   ...
   */
  public metricHttpRedirectUrlLimitExceededCount(
    props?: cloudwatch.MetricOptions,
  ) {
   ...
   */
  public metricTargetTLSNegotiationErrorCount(
    props?: cloudwatch.MetricOptions,
  ) {
  ...
  implements IApplicationLoadBalancerMetrics
{
  ...
  public activeConnectionCount(props?: cloudwatch.MetricOptions) {
    return this.cannedMetric(
      ApplicationELBMetrics.activeConnectionCountSum,
      props,
    );
  }
  ...
  public httpFixedResponseCount(props?: cloudwatch.MetricOptions) {
    return this.cannedMetric(
      ApplicationELBMetrics.httpFixedResponseCountSum,
      props,
    );
  }
  ...
  public httpRedirectUrlLimitExceededCount(props?: cloudwatch.MetricOptions) {
    return this.cannedMetric(
      ApplicationELBMetrics.httpRedirectUrlLimitExceededCountSum,
      props,
    );
  }
  ...
  public ipv6ProcessedBytes(props?: cloudwatch.MetricOptions) {
    return this.cannedMetric(
      ApplicationELBMetrics.iPv6ProcessedBytesSum,
      props,
    );
  }
 ...
 */
class ImportedApplicationLoadBalancer
...
// TODO: Add Grid Lookup support
// class LookedUpApplicationLoadBalancer
//   extends AwsConstructBase
//   implements IApplicationLoadBalancer
// {
//   public readonly loadBalancerArn: string;
