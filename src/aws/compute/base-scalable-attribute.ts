// https://github.com/aws/aws-cdk/blob/v2.168.0/packages/aws-cdk-lib/aws-applicationautoscaling/lib/base-scalable-attribute.ts
...
export abstract class BaseScalableAttribute extends Construct {
   ...
   */
  protected doScaleToTrackMetric(
    id: string,
