...
import { FunctionOptions, LambdaFunction } from "../function";
  ...
  constructor(scope: Construct, id: string, props: NodejsFunctionProps = {}) {
    ...
    if (props.code !== undefined) {
      ...
      super(scope, id, {
        ...
        handler:
          handler.indexOf(".") !== -1 ? `${handler}` : `index.${handler}`,
      });
    }
...
/**
 * default to NODEJS_LATEST.
 */
function getRuntime(props: NodejsFunctionProps): Runtime {
  return props.runtime ?? Runtime.NODEJS_LATEST;
}
