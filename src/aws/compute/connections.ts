// https://github.com/aws/aws-cdk/blob/v2.175.1/packages/aws-cdk-lib/aws-ec2/lib/connections.ts
...
export class Connections implements IConnectable {
  ...
  public allowToDefaultPort(other: IConnectable, description?: string) {
    if (other.connections.defaultPort === undefined) {
      throw new Error(
        "Cannot call allowToDefaultPort(): other resource has no default port",
      );
    }
  ...
  public allowDefaultPortTo(other: IConnectable, description?: string) {
    if (!this.defaultPort) {
      throw new Error(
        "Cannot call allowDefaultPortTo(): this resource has no default port",
      );
    }
