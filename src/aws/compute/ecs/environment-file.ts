// https://github.com/aws/aws-cdk/blob/v2.233.0/packages/aws-cdk-lib/aws-ecs/lib/environment-file.ts

import { Construct } from "constructs";
import { ValidationError } from "../../../errors";
import { Asset, AssetOptions } from "../../storage/assets/s3";
import { IBucket } from "../../storage/bucket";
import { S3Location } from "../../storage/location";
  ...
  public bind(scope: Construct): EnvironmentFileConfig {
    ...
    if (!this.asset.isFile) {
      throw new ValidationError(
        `Asset must be a single file (${this.path})`,
        scope,
      );
    }
