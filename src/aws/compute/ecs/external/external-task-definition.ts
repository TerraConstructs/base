// https://github.com/aws/aws-cdk/blob/v2.233.0/packages/aws-cdk-lib/aws-ecs/lib/external/external-task-definition.ts
 ...
 */
export interface ExternalTaskDefinitionAttributes
 ...
 */
export class ExternalTaskDefinition
  ...
  implements IExternalTaskDefinition
{
  ...
  public static readonly PROPERTY_INJECTION_ID: string =
    "terraconstructs.aws.ecs.ExternalTaskDefinition";
