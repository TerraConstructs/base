// https://github.com/aws/aws-cdk/blob/v2.233.0/packages/aws-cdk-lib/aws-ecs/lib/log-drivers/fluentd-log-driver.ts
  ...
  public bind(
    ...
    return {
      ...
      options: stringifyOptions({
        ...
        "fluentd-retry-wait":
          this.props.retryWait && this.props.retryWait.toSeconds(),
