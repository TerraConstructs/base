// https://github.com/aws/aws-cdk/blob/v2.233.0/packages/aws-cdk-lib/aws-ecs/lib/log-drivers/gelf-log-driver.ts
    ...
    return {
      ...
      options: stringifyOptions({
        ...
        "gelf-tcp-reconnect-delay":
          this.props.tcpReconnectDelay &&
          this.props.tcpReconnectDelay.toSeconds(),
