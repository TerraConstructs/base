// https://github.com/aws/aws-cdk/blob/v2.233.0/packages/aws-cdk-lib/aws-ecs/lib/credential-spec.ts

import { ValidationError } from "../../../errors";
import { IBucket } from "../../storage/bucket";
...
export class DomainJoinedCredentialSpec extends CredentialSpec {
  ...
  public static fromS3Bucket(bucket: IBucket, key: string) {
    return new DomainJoinedCredentialSpec(
      CredentialSpec.arnForS3Object(bucket, key),
    );
  }
  ...
  public static fromSsmParameter(parameter: IParameter) {
    return new DomainJoinedCredentialSpec(
      CredentialSpec.arnForSsmParameter(parameter),
    );
  }
...
export class DomainlessCredentialSpec extends CredentialSpec {
   ...
   */
  public static fromS3Bucket(bucket: IBucket, key: string) {
    return new DomainlessCredentialSpec(
      CredentialSpec.arnForS3Object(bucket, key),
    );
  }
