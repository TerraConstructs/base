// https://github.com/aws/aws-cdk/blob/v2.233.0/packages/aws-cdk-lib/aws-ecs/lib/fargate/fargate-task-definition.ts
 ...
 */
export interface FargateTaskDefinitionAttributes
  ...
  implements IFargateTaskDefinition
{
  ...
  public static readonly PROPERTY_INJECTION_ID: string =
    "terraconstructs.aws.ecs.FargateTaskDefinition";
  ...
  public static fromFargateTaskDefinitionArn(
    ...
    return new ImportedTaskDefinition(scope, id, {
      taskDefinitionArn: fargateTaskDefinitionArn,
    });
  }
  ...
  constructor(
    ...
    if (props.pidMode) {
      ...
      if (props.runtimePlatform?.operatingSystemFamily?.isWindows()) {
        throw new ValidationError(
          "'pidMode' is not supported for Windows containers.",
          this,
        );
      }
      if (
