// https://github.com/aws/aws-cdk/blob/v2.233.0/packages/aws-cdk-lib/aws-ecs/lib/images/repository.ts
...
export class RepositoryImage extends ContainerImage {
  ...
  constructor(
    ...
    private readonly props: RepositoryImageProps = {},
  ) {
    super();
  }
  ...
  public bind(
    ...
    if (
      !Token.isUnresolved(this.imageName) &&
      ECR_IMAGE_REGEX.test(this.imageName)
    ) {
      // TODO: Annotations.of(scope).addWarningV2('@aws-cdk/aws-ecs:ecrImageRequiresPolicy', ...)
    ...
    if (this.props.credentials) {
      this.props.credentials.grantRead(
