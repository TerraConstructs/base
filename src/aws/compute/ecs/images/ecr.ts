// https://github.com/aws/aws-cdk/blob/v2.233.0/packages/aws-cdk-lib/aws-ecs/lib/images/ecr.ts
...
export class EcrImage extends ContainerImage {
  ...
  constructor(
    ...
    private readonly tagOrDigest: string,
  ) {
    super();

    this.imageName = this.repository.repositoryUriForTagOrDigest(
      this.tagOrDigest,
    );
  }
