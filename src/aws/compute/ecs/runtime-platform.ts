// https://github.com/aws/aws-cdk/blob/v2.233.0/packages/aws-cdk-lib/aws-ecs/lib/runtime-platform.ts
...
export class OperatingSystemFamily {
   ...
   */
  public static readonly WINDOWS_SERVER_2025_FULL = OperatingSystemFamily.of(
    "WINDOWS_SERVER_2025_FULL",
  );
  /**
   * WINDOWS_SERVER_2025_CORE
   */
  public static readonly WINDOWS_SERVER_2025_CORE = OperatingSystemFamily.of(
    "WINDOWS_SERVER_2025_CORE",
  );
