...
import { placementGroup } from "@cdktn/provider-aws";
  ...
  implements IPlacementGroup
{
  ...
  public static fromPlacementGroupName(
    ...
    class Import extends AwsConstructBase implements IPlacementGroup {
  ...
  public readonly resource: placementGroup.PlacementGroup;
  ...
  constructor(scope: Construct, id: string, props: PlacementGroupProps = {}) {
    ...
    this.resource = new placementGroup.PlacementGroup(this, "Resource", {
