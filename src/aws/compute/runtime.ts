...
export class Runtime {
   ...
   * @deprecated Legacy runtime no longer supported by AWS Lambda. Migrate to the latest NodeJS runtime.
   */
  public static readonly NODEJS_4_3 = new Runtime(
    "nodejs4.3",
   ...
   * @deprecated Legacy runtime no longer supported by AWS Lambda. Migrate to the latest NodeJS runtime.
   */
  public static readonly NODEJS_6_10 = new Runtime(
    "nodejs6.10",
    RuntimeFamily.NODEJS,
    { supportsInlineCode: true },
  );
   ...
   * @deprecated Legacy runtime no longer supported by AWS Lambda. Migrate to the latest NodeJS runtime.
   */
  public static readonly NODEJS_8_10 = new Runtime(
    "nodejs8.10",
    RuntimeFamily.NODEJS,
    { supportsInlineCode: true },
  );
   ...
   * @deprecated Legacy runtime no longer supported by AWS Lambda. Migrate to the latest NodeJS runtime.
   */
  public static readonly NODEJS_10_X = new Runtime(
    "nodejs10.x",
    RuntimeFamily.NODEJS,
    { supportsInlineCode: true },
  );
   ...
   * @deprecated Legacy runtime no longer supported by AWS Lambda. Migrate to the latest NodeJS runtime.
   */
  public static readonly NODEJS_12_X = new Runtime(
    "nodejs12.x",
    RuntimeFamily.NODEJS,
    { supportsInlineCode: true },
  );
   ...
   * @deprecated Legacy runtime no longer supported by AWS Lambda. Migrate to the latest NodeJS runtime.
   */
  public static readonly NODEJS_14_X = new Runtime(
    "nodejs14.x",
    RuntimeFamily.NODEJS,
    { supportsInlineCode: true },
  );
   ...
   * @deprecated Legacy runtime no longer supported by AWS Lambda. Migrate to the latest NodeJS runtime.
   */
  public static readonly NODEJS_16_X = new Runtime(
    "nodejs16.x",
    RuntimeFamily.NODEJS,
    { supportsInlineCode: true },
  );
   ...
   */
  public static readonly NODEJS_18_X = new Runtime(
    "nodejs18.x",
    RuntimeFamily.NODEJS,
    { supportsInlineCode: true },
  );
   ...
   */
  public static readonly NODEJS_20_X = new Runtime(
    "nodejs20.x",
    RuntimeFamily.NODEJS,
    { supportsInlineCode: true },
  );
   ...
   */
  public static readonly PYTHON_2_7 = new Runtime(
    "python2.7",
   ...
   * @deprecated Legacy runtime no longer supported by AWS Lambda. Migrate to the latest Python runtime.
   */
  public static readonly PYTHON_3_6 = new Runtime(
    "python3.6",
    RuntimeFamily.PYTHON,
    {
      supportsInlineCode: true,
   ...
   * @deprecated Legacy runtime no longer supported by AWS Lambda. Migrate to the latest Python runtime.
   */
  public static readonly PYTHON_3_7 = new Runtime(
    "python3.7",
    RuntimeFamily.PYTHON,
    {
      supportsInlineCode: true,
   ...
   * @deprecated Legacy runtime no longer supported by AWS Lambda. Migrate to the latest Python runtime.
   */
  public static readonly PYTHON_3_8 = new Runtime(
    "python3.8",
    RuntimeFamily.PYTHON,
    {
      supportsInlineCode: true,
   ...
   */
  public static readonly PYTHON_3_9 = new Runtime(
    "python3.9",
    RuntimeFamily.PYTHON,
    {
      supportsInlineCode: true,
   ...
   */
  public static readonly PYTHON_3_10 = new Runtime(
    "python3.10",
    RuntimeFamily.PYTHON,
    {
      supportsInlineCode: true,
   ...
   */
  public static readonly PYTHON_3_11 = new Runtime(
    "python3.11",
    RuntimeFamily.PYTHON,
    {
      supportsInlineCode: true,
   ...
   */
  public static readonly PYTHON_3_12 = new Runtime(
    "python3.12",
    RuntimeFamily.PYTHON,
    {
      supportsInlineCode: true,
   ...
   */
  public static readonly JAVA_8_CORRETTO = new Runtime(
    "java8.al2",
    RuntimeFamily.JAVA,
    {
      supportsCodeGuruProfiling: true,
   ...
   */
  public static readonly DOTNET_6 = new Runtime(
    "dotnet6",
   ...
   */
  public static readonly DOTNET_8 = new Runtime(
    "dotnet8",
    RuntimeFamily.DOTNET_CORE,
    {
      supportsSnapStart: true,
   ...
   */
  public static readonly DOTNET_9 = new Runtime(
    "dotnet9",
    RuntimeFamily.DOTNET_CORE,
    {
      supportsSnapStart: true,
   ...
   */
  public static readonly DOTNET_CORE_1 = new Runtime(
    "dotnetcore1.0",
    RuntimeFamily.DOTNET_CORE,
  );
   ...
   * @deprecated Legacy runtime no longer supported by AWS Lambda. Migrate to the latest .NET Core runtime.
   */
  public static readonly DOTNET_CORE_2 = new Runtime(
    "dotnetcore2.0",
    RuntimeFamily.DOTNET_CORE,
  );
   ...
   * @deprecated Legacy runtime no longer supported by AWS Lambda. Migrate to the latest .NET Core runtime.
   */
  public static readonly DOTNET_CORE_2_1 = new Runtime(
    "dotnetcore2.1",
    RuntimeFamily.DOTNET_CORE,
  );
   ...
   * @deprecated Legacy runtime no longer supported by AWS Lambda. Migrate to the latest .NET Core runtime.
   */
  public static readonly DOTNET_CORE_3_1 = new Runtime(
    "dotnetcore3.1",
    RuntimeFamily.DOTNET_CORE,
  );
   ...
   */
  public static readonly PROVIDED = new Runtime(
    "provided",
    RuntimeFamily.OTHER,
  );
   ...
   */
  public static readonly PROVIDED_AL2 = new Runtime(
    "provided.al2",
    RuntimeFamily.OTHER,
  );
   ...
   */
  public static readonly PROVIDED_AL2023 = new Runtime(
    "provided.al2023",
    RuntimeFamily.OTHER,
  );
  ...
  constructor(
    ...
    const imageName =
      props.bundlingDockerImage ?? `public.ecr.aws/sam/build-${name}`;
    this.bundlingImage = DockerImage.fromRegistry(imageName);
