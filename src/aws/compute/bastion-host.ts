...
import { IPrincipal, IRole, PolicyStatement } from "../iam";
 ...
 */
export class BastionHostLinux extends AwsConstructBase implements IInstance {
  ...
  constructor(scope: Construct, id: string, props: BastionHostLinuxProps) {
    ...
    new TerraformOutput(this, "BastionHostId", {
      description:
        "Instance ID of the bastion host. Use this to connect via SSM Session Manager",
  ...
  private getMachineImage(
    ...
    const defaultMachineImage = MachineImage.latestAmazonLinux2023({
