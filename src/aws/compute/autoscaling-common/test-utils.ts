// https://github.com/aws/aws-cdk/blob/v2.186.0/packages/aws-cdk-lib/aws-autoscaling-common/lib/test-utils.ts

import * as appscaling from ".";
 ...
 */
export function generateArbitraryIntervals(
  mrng: IRandomGenerator,
): ArbitraryIntervals {
  ...
  for (let iter = 0; iter < iterations; iter++) {
    ...
    if (mrng.nextBoolean()) {
      ...
      if (
        ...
        (i === ret.length - 1 || ret[i + 1].lower !== undefined)
      ) {
