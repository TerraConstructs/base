...
export class DataProtectionPolicy {
  ...
  public _bind(
    ...
    const description =
      this.dataProtectionPolicyProps.description ||
    ...
    if (this.dataProtectionPolicyProps.logGroupAuditDestination) {
      findingsDestination.cloudWatchLogs = {
        logGroup:
          this.dataProtectionPolicyProps.logGroupAuditDestination.logGroupName,
      };
    }
    ...
    if (this.dataProtectionPolicyProps.s3BucketAuditDestination) {
      findingsDestination.s3 = {
        bucket:
          this.dataProtectionPolicyProps.s3BucketAuditDestination.bucketName,
      };
    }
    ...
    if (this.dataProtectionPolicyProps.deliveryStreamNameAuditDestination) {
      findingsDestination.firehose = {
        deliveryStream:
          this.dataProtectionPolicyProps.deliveryStreamNameAuditDestination,
      };
    }
...
export class DataIdentifier {
  ...
  public static readonly BANKACCOUNTNUMBER_DE = new DataIdentifier(
    "BankAccountNumber-DE",
  );
  public static readonly BANKACCOUNTNUMBER_ES = new DataIdentifier(
    "BankAccountNumber-ES",
  );
  public static readonly BANKACCOUNTNUMBER_FR = new DataIdentifier(
    "BankAccountNumber-FR",
  );
  public static readonly BANKACCOUNTNUMBER_GB = new DataIdentifier(
    "BankAccountNumber-GB",
  );
  public static readonly BANKACCOUNTNUMBER_IT = new DataIdentifier(
    "BankAccountNumber-IT",
  );
  public static readonly BANKACCOUNTNUMBER_US = new DataIdentifier(
  ...
  public static readonly CREDITCARDEXPIRATION = new DataIdentifier(
    "CreditCardExpiration",
  );
  public static readonly CREDITCARDNUMBER = new DataIdentifier(
    "CreditCardNumber",
  );
  public static readonly CREDITCARDSECURITYCODE = new DataIdentifier(
    "CreditCardSecurityCode",
  );
  public static readonly DRIVERSLICENSE_AT = new DataIdentifier(
    "DriversLicense-AT",
  );
  public static readonly DRIVERSLICENSE_AU = new DataIdentifier(
    "DriversLicense-AU",
  );
  public static readonly DRIVERSLICENSE_BE = new DataIdentifier(
    "DriversLicense-BE",
  );
  public static readonly DRIVERSLICENSE_BG = new DataIdentifier(
    "DriversLicense-BG",
  );
  public static readonly DRIVERSLICENSE_CA = new DataIdentifier(
    "DriversLicense-CA",
  );
  public static readonly DRIVERSLICENSE_CY = new DataIdentifier(
    "DriversLicense-CY",
  );
  public static readonly DRIVERSLICENSE_CZ = new DataIdentifier(
    "DriversLicense-CZ",
  );
  public static readonly DRIVERSLICENSE_DE = new DataIdentifier(
    "DriversLicense-DE",
  );
  public static readonly DRIVERSLICENSE_DK = new DataIdentifier(
    "DriversLicense-DK",
  );
  public static readonly DRIVERSLICENSE_EE = new DataIdentifier(
    "DriversLicense-EE",
  );
  public static readonly DRIVERSLICENSE_ES = new DataIdentifier(
    "DriversLicense-ES",
  );
  public static readonly DRIVERSLICENSE_FI = new DataIdentifier(
    "DriversLicense-FI",
  );
  public static readonly DRIVERSLICENSE_FR = new DataIdentifier(
    "DriversLicense-FR",
  );
  public static readonly DRIVERSLICENSE_GB = new DataIdentifier(
    "DriversLicense-GB",
  );
  public static readonly DRIVERSLICENSE_GR = new DataIdentifier(
    "DriversLicense-GR",
  );
  public static readonly DRIVERSLICENSE_HR = new DataIdentifier(
    "DriversLicense-HR",
  );
  public static readonly DRIVERSLICENSE_HU = new DataIdentifier(
    "DriversLicense-HU",
  );
  public static readonly DRIVERSLICENSE_IE = new DataIdentifier(
    "DriversLicense-IE",
  );
  public static readonly DRIVERSLICENSE_IT = new DataIdentifier(
    "DriversLicense-IT",
  );
  public static readonly DRIVERSLICENSE_LT = new DataIdentifier(
    "DriversLicense-LT",
  );
  public static readonly DRIVERSLICENSE_LU = new DataIdentifier(
    "DriversLicense-LU",
  );
  public static readonly DRIVERSLICENSE_LV = new DataIdentifier(
    "DriversLicense-LV",
  );
  public static readonly DRIVERSLICENSE_MT = new DataIdentifier(
    "DriversLicense-MT",
  );
  public static readonly DRIVERSLICENSE_NL = new DataIdentifier(
    "DriversLicense-NL",
  );
  public static readonly DRIVERSLICENSE_PL = new DataIdentifier(
    "DriversLicense-PL",
  );
  public static readonly DRIVERSLICENSE_PT = new DataIdentifier(
    "DriversLicense-PT",
  );
  public static readonly DRIVERSLICENSE_RO = new DataIdentifier(
    "DriversLicense-RO",
  );
  public static readonly DRIVERSLICENSE_SE = new DataIdentifier(
    "DriversLicense-SE",
  );
  public static readonly DRIVERSLICENSE_SI = new DataIdentifier(
    "DriversLicense-SI",
  );
  public static readonly DRIVERSLICENSE_SK = new DataIdentifier(
    "DriversLicense-SK",
  );
  public static readonly DRIVERSLICENSE_US = new DataIdentifier(
    "DriversLicense-US",
  );
  public static readonly DRUGENFORCEMENTAGENCYNUMBER_US = new DataIdentifier(
    "DrugEnforcementAgencyNumber-US",
  );
  public static readonly ELECTORALROLLNUMBER_GB = new DataIdentifier(
  ...
  public static readonly HEALTHINSURANCENUMBER_FR = new DataIdentifier(
    "HealthInsuranceNumber-FR",
  );
  public static readonly HEALTHCAREPROCEDURECODE_US = new DataIdentifier(
    "HealthcareProcedureCode-US",
  );
  public static readonly INDIVIDUALTAXIDENTIFICATIONNUMBER_US =
    new DataIdentifier("IndividualTaxIdentificationNumber-US");
  ...
  public static readonly NATIONALDRUGCODE_US = new DataIdentifier(
    "NationalDrugCode-US",
  );
  ...
  public static readonly OPENSSHPRIVATEKEY = new DataIdentifier(
    "OpenSshPrivateKey",
  );
  public static readonly PASSPORTNUMBER_CA = new DataIdentifier(
    "PassportNumber-CA",
  );
  public static readonly PASSPORTNUMBER_DE = new DataIdentifier(
    "PassportNumber-DE",
  );
  public static readonly PASSPORTNUMBER_ES = new DataIdentifier(
    "PassportNumber-ES",
  );
  public static readonly PASSPORTNUMBER_FR = new DataIdentifier(
    "PassportNumber-FR",
  );
  public static readonly PASSPORTNUMBER_GB = new DataIdentifier(
    "PassportNumber-GB",
  );
  public static readonly PASSPORTNUMBER_IT = new DataIdentifier(
    "PassportNumber-IT",
  );
  public static readonly PASSPORTNUMBER_US = new DataIdentifier(
    "PassportNumber-US",
  );
  public static readonly PERMANENTRESIDENCENUMBER_CA = new DataIdentifier(
    "PermanentResidenceNumber-CA",
  );
  public static readonly PERSONALHEALTHNUMBER_CA = new DataIdentifier(
  ...
  public static readonly PUTTYPRIVATEKEY = new DataIdentifier(
    "PuttyPrivateKey",
  );
  public static readonly RGNUMBER_BR = new DataIdentifier("RgNumber-BR");
  public static readonly SOCIALINSURANCENUMBER_CA = new DataIdentifier(
