...
export class CompositeAlarm extends AlarmBase {
  ...
  public readonly resource: cloudwatchCompositeAlarm.CloudwatchCompositeAlarm;
  ...
  constructor(scope: Construct, id: string, props: CompositeAlarmProps) {
    ...
    this.resource = new cloudwatchCompositeAlarm.CloudwatchCompositeAlarm(
      this,
      "Resource",
      {
        alarmName,
        ...
        ...(props.actionsSuppressor
          ? {
              actionsSuppressor: {
                alarm: props.actionsSuppressor?.alarmArn,
                extensionPeriod: extensionPeriod!.toSeconds(),
                waitPeriod: waitPeriod!.toSeconds(),
              },
            }
          : undefined),
      },
