// https://github.com/aws/aws-cdk/blob/v2.170.0/packages/aws-cdk-lib/aws-cloudwatch/lib/graph.ts
...
export class AlarmWidget extends ConcreteWidget {
  ...
  constructor(scope: Construct, props: AlarmWidgetProps) {
    super(scope, props.width || 6, props.height || 6);
    this.props = props;
  }
...
export class GraphWidget extends ConcreteWidget {
  ...
  public toJson(): any[] {
    ...
    const verticalAnnotations = (this.props.verticalAnnotations || []).map(
      ({ date, ...rest }) => ({
        value: date,
        ...rest,
      }),
        ...
        ? {
            horizontal:
              horizontalAnnotations.length > 0
                ...
                : undefined,
            vertical:
              verticalAnnotations.length > 0 ? verticalAnnotations : undefined,
          }
        : undefined;
...
export class TableWidget extends ConcreteWidget {
  ...
  public toJson(): any[] {
    const horizontalAnnotations = (this.props.thresholds ?? []).map(
    ...
    return [
      {
        ...
        properties: {
          ...
          table: {
            ...
            showTimeSeriesData: !(
              this.props.summary?.hideNonSummaryColumns ?? false
            ),
...
export class CustomWidget extends ConcreteWidget {
  ...
  public constructor(scope: Construct, props: CustomWidgetProps) {
    super(scope, props.width ?? 6, props.height ?? 6);
    this.props = props;
  }
