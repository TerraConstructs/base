...
abstract class AliasBase extends AwsConstructBase implements IAlias {
  ...
  public get aliasOutputs(): AliasOutputs {
    return {
      ...
      aliasTargetKey: this.keyOutputs,
    };
  }
  public get keyOutputs(): KeyOutputs {
    return this.aliasTargetKey.keyOutputs;
  }
...
export class Alias extends AliasBase {
  ...
  public static fromAliasName(
    ...
    class Import extends AwsConstructBase implements IAlias {
      ...
      public addAlias(_alias: string): Alias {
        throw new Error(
          "Cannot call addAlias on an Alias imported by Alias.fromAliasName().",
        );
      }
      public addToResourcePolicy(
  ...
  public readonly resource: kmsAlias.KmsAlias;
  ...
  constructor(scope: Construct, id: string, props: AliasProps) {
    ...
    this.resource = new kmsAlias.KmsAlias(this, "Resource", {
      name: aliasName,
      targetKeyId: this.aliasTargetKey.keyArn,
    });

    this.aliasName = this.resource.name;
  }
}
