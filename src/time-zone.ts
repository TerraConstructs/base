// https://github.com/aws/aws-cdk/blob/v2.186.0/packages/aws-cdk-lib/core/lib/time-zone.ts
...
export class TimeZone {
  ...
  public static readonly AMERICA_OJINAGA = new TimeZone("America/Ojinaga");

  /** IANA Time Zone database entry for America/Panama.  UTC offset −05:00/−05:00. */
  public static readonly AMERICA_PANAMA = new TimeZone("America/Panama");

  /** IANA Time Zone database entry for America/Paramaribo.  UTC offset −03:00/−03:00. */
  public static readonly AMERICA_PARAMARIBO = new TimeZone(
    "America/Paramaribo",
  );
   ...
   */
  public static of(timezoneName: string): TimeZone {
